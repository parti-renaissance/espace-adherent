...
final class Version20210708133208 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        $this->addSql('CREATE TABLE member_summary_job_experiences (
          ...
          company VARCHAR(255) CHARACTER SET utf8 NOT NULL COLLATE `utf8_unicode_ci`,
          position VARCHAR(255) CHARACTER SET utf8 NOT NULL COLLATE `utf8_unicode_ci`,
          location VARCHAR(255) CHARACTER SET utf8 NOT NULL COLLATE `utf8_unicode_ci`,
          website VARCHAR(255) CHARACTER SET utf8 DEFAULT NULL COLLATE `utf8_unicode_ci`,
          company_facebook_page VARCHAR(255) CHARACTER SET utf8 DEFAULT NULL COLLATE `utf8_unicode_ci`,
          company_twitter_nickname VARCHAR(255) CHARACTER SET utf8 DEFAULT NULL COLLATE `utf8_unicode_ci`,
          started_at DATE NOT NULL,
          ended_at DATE DEFAULT NULL,
          on_going TINYINT(1) DEFAULT \'0\' NOT NULL,
          contract VARCHAR(255) CHARACTER SET utf8 NOT NULL COLLATE `utf8_unicode_ci`,
          duration VARCHAR(255) CHARACTER SET utf8 NOT NULL COLLATE `utf8_unicode_ci`,
        ...
        $this->addSql('CREATE TABLE member_summary_languages (
          ...
          level VARCHAR(255) CHARACTER SET utf8 NOT NULL COLLATE `utf8_unicode_ci`,
        ...
        $this->addSql('CREATE TABLE member_summary_trainings (
          id INT AUTO_INCREMENT NOT NULL,
          summary_id INT DEFAULT NULL,
          organization VARCHAR(255) CHARACTER SET utf8 NOT NULL COLLATE `utf8_unicode_ci`,
          diploma VARCHAR(255) CHARACTER SET utf8 NOT NULL COLLATE `utf8_unicode_ci`,
          study_field VARCHAR(255) CHARACTER SET utf8 NOT NULL COLLATE `utf8_unicode_ci`,
          started_at DATE NOT NULL,
          ended_at DATE DEFAULT NULL,
          on_going TINYINT(1) DEFAULT \'0\' NOT NULL,
          description LONGTEXT CHARACTER SET utf8 DEFAULT NULL COLLATE `utf8_unicode_ci`,
          extra_curricular LONGTEXT CHARACTER SET utf8 DEFAULT NULL COLLATE `utf8_unicode_ci`,
          display_order SMALLINT DEFAULT 1 NOT NULL,
        ...
        $this->addSql('CREATE TABLE summaries (
          ...
          slug VARCHAR(255) CHARACTER SET utf8 NOT NULL COLLATE `utf8_unicode_ci`,
          current_profession VARCHAR(255) CHARACTER SET utf8 DEFAULT NULL COLLATE `utf8_unicode_ci`,
          contribution_wish VARCHAR(255) CHARACTER SET utf8 NOT NULL COLLATE `utf8_unicode_ci`,
          professional_synopsis LONGTEXT CHARACTER SET utf8 NOT NULL COLLATE `utf8_unicode_ci`,
          motivation LONGTEXT CHARACTER SET utf8 NOT NULL COLLATE `utf8_unicode_ci`,
          contact_email VARCHAR(255) CHARACTER SET utf8 NOT NULL COLLATE `utf8_unicode_ci`,
          linked_in_url VARCHAR(255) CHARACTER SET utf8 DEFAULT NULL COLLATE `utf8_unicode_ci`,
          website_url VARCHAR(255) CHARACTER SET utf8 DEFAULT NULL COLLATE `utf8_unicode_ci`,
          facebook_url VARCHAR(255) CHARACTER SET utf8 DEFAULT NULL COLLATE `utf8_unicode_ci`,
          twitter_nickname VARCHAR(255) CHARACTER SET utf8 DEFAULT NULL COLLATE `utf8_unicode_ci`,
          viadeo_url VARCHAR(255) CHARACTER SET utf8 DEFAULT NULL COLLATE `utf8_unicode_ci`,
          availabilities LONGTEXT CHARACTER SET utf8 DEFAULT NULL COLLATE `utf8_unicode_ci` COMMENT \'(DC2Type:simple_array)\',
          job_locations LONGTEXT CHARACTER SET utf8 DEFAULT NULL COLLATE `utf8_unicode_ci` COMMENT \'(DC2Type:simple_array)\',
