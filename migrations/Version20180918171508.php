...
final class Version20180918171508 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE geo_data (id INT UNSIGNED AUTO_INCREMENT NOT NULL, geo_shape GEOMETRY NOT NULL COMMENT \'(DC2Type:geometry)\', SPATIAL INDEX geo_data_geo_shape_idx (geo_shape), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
