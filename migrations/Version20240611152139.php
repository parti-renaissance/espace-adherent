...
final class Version20240611152139 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        $this->addSql('CREATE TABLE hub_item (
        ...
        $this->addSql('ALTER TABLE
          hub_item
        ADD
          CONSTRAINT FK_195C97A29DF5350C FOREIGN KEY (created_by_administrator_id) REFERENCES administrators (id) ON DELETE
        SET
          NULL');
        $this->addSql('ALTER TABLE
          hub_item
        ADD
          CONSTRAINT FK_195C97A2CF1918FF FOREIGN KEY (updated_by_administrator_id) REFERENCES administrators (id) ON DELETE
        SET
          NULL');
    }
