...
final class Version20181205101657 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE ideas_workshop_ideas_themes (idea_id INT UNSIGNED NOT NULL, theme_id INT NOT NULL, INDEX IDX_DB4ED3145B6FEF7D (idea_id), INDEX IDX_DB4ED31459027487 (theme_id), PRIMARY KEY(idea_id, theme_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
