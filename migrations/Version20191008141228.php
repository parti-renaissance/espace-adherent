...
final class Version20191008141228 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE donator_donator_tag (donator_id INT UNSIGNED NOT NULL, donator_tag_id INT UNSIGNED NOT NULL, INDEX IDX_6BAEC28C831BACAF (donator_id), INDEX IDX_6BAEC28C71F026E6 (donator_tag_id), PRIMARY KEY(donator_id, donator_tag_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
