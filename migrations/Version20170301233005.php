...
class Version20170301233005 extends AbstractMigration
{
    ...
    {
        $this->addSql('ALTER TABLE je_marche_reports CHANGE convinced convinced LONGTEXT NOT NULL COLLATE utf8mb4_unicode_ci COMMENT \'(DC2Type:simple_array)\', CHANGE almost_convinced almost_convinced LONGTEXT NOT NULL COLLATE utf8mb4_unicode_ci COMMENT \'(DC2Type:simple_array)\'');
    }
}
