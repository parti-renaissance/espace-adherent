...
use App\DataFixtures\ORM\LoadBoardMemberRoleData;
...
class Version20171011100525 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE board_member (id INT AUTO_INCREMENT NOT NULL, adherent_id INT UNSIGNED DEFAULT NULL, area VARCHAR(50) NOT NULL, UNIQUE INDEX UNIQ_DCFABEDF25F06C53 (adherent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE board_member_roles (board_member_id INT NOT NULL, role_id INT UNSIGNED NOT NULL, INDEX IDX_1DD1E043C7BA2FD5 (board_member_id), INDEX IDX_1DD1E043D60322AC (role_id), PRIMARY KEY(board_member_id, role_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE roles (id INT UNSIGNED AUTO_INCREMENT NOT NULL, code VARCHAR(20) NOT NULL, name VARCHAR(100) NOT NULL, UNIQUE INDEX board_member_role_code_unique (code), UNIQUE INDEX board_member_role_name_unique (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
