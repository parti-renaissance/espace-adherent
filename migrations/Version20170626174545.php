...
class Version20170626174545 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE member_summary_trainings CHANGE ended_at ended_at DATE NOT NULL, CHANGE extra_curricular extracurricular LONGTEXT DEFAULT NULL COLLATE utf8mb4_unicode_ci');
        $this->addSql('ALTER TABLE summaries CHANGE availabilities availabilities LONGTEXT NOT NULL COLLATE utf8mb4_unicode_ci COMMENT \'(DC2Type:simple_array)\', CHANGE job_locations job_locations LONGTEXT NOT NULL COLLATE utf8mb4_unicode_ci COMMENT \'(DC2Type:simple_array)\', CHANGE showing_recent_activities showing_recent_activities SMALLINT DEFAULT 0 NOT NULL, CHANGE public public SMALLINT DEFAULT 0 NOT NULL');
    }
}
