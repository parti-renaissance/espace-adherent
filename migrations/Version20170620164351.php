...
class Version20170620164351 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE member_summary_languages (id INT AUTO_INCREMENT NOT NULL, summary_id INT DEFAULT NULL, code VARCHAR(255) NOT NULL, level VARCHAR(255) NOT NULL, INDEX IDX_70C88322AC2D45C (summary_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE member_summary_mission_types (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE member_summary_skills (id INT AUTO_INCREMENT NOT NULL, summary_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, INDEX IDX_CB3F6F8F2AC2D45C (summary_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE summary_mission_type_wishes (summary_id INT NOT NULL, mission_type_id INT NOT NULL, INDEX IDX_7F3FC70F2AC2D45C (summary_id), INDEX IDX_7F3FC70F547018DE (mission_type_id), PRIMARY KEY(summary_id, mission_type_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
