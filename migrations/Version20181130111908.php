...
final class Version20181130111908 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ideas_workshop_consultation_report (id INT AUTO_INCREMENT NOT NULL, url VARCHAR(255) NOT NULL, position SMALLINT UNSIGNED NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE ideas_workshop_thread (id INT AUTO_INCREMENT NOT NULL, answer_id INT DEFAULT NULL, status VARCHAR(9) DEFAULT \'SUBMITTED\' NOT NULL, INDEX IDX_CE975BDDAA334807 (answer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE ideas_workshop_ideas_needs (idea_id INT UNSIGNED NOT NULL, need_id INT NOT NULL, INDEX IDX_75CEB995B6FEF7D (idea_id), INDEX IDX_75CEB99624AF264 (need_id), PRIMARY KEY(idea_id, need_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE ideas_workshop_guideline (id INT AUTO_INCREMENT NOT NULL, enabled TINYINT(1) NOT NULL, position SMALLINT UNSIGNED NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
