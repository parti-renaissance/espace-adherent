...
class Version20180212214213 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE event_user_documents (event_id INT UNSIGNED NOT NULL, user_document_id INT UNSIGNED NOT NULL, INDEX IDX_7D14491F71F7E88B (event_id), INDEX IDX_7D14491F6A24B1A2 (user_document_id), PRIMARY KEY(event_id, user_document_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
