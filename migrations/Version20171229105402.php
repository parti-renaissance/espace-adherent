...
class Version20171229105402 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE timeline_measures_profiles (measure_id BIGINT NOT NULL, profile_id BIGINT NOT NULL, INDEX IDX_B83D81AE5DA37D00 (measure_id), INDEX IDX_B83D81AECCFA12B8 (profile_id), PRIMARY KEY(measure_id, profile_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE timeline_profiles (id BIGINT AUTO_INCREMENT NOT NULL, title VARCHAR(100) NOT NULL, slug VARCHAR(100) NOT NULL, description LONGTEXT NOT NULL, UNIQUE INDEX UNIQ_DB00DE3B989D9B62 (slug), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
