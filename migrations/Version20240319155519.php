...
final class Version20240319155519 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        ADD
          CONSTRAINT FK_F6D458CBDB26A4E FOREIGN KEY (proxy_id) REFERENCES procuration_v2_proxies (id) ON DELETE
        SET
          NULL');
