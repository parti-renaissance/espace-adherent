...
final class Version20190524115905 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE application_request_running_mate (id INT UNSIGNED AUTO_INCREMENT NOT NULL, curriculum_name VARCHAR(255) NOT NULL, is_local_association_member TINYINT(1) NOT NULL, local_association_domain LONGTEXT NOT NULL, is_political_activist TINYINT(1) NOT NULL, political_activist_details LONGTEXT NOT NULL, is_previous_elected_official TINYINT(1) NOT NULL, previous_elected_official_details LONGTEXT NOT NULL, favorite_theme_details LONGTEXT NOT NULL, project_details LONGTEXT NOT NULL, professional_assets LONGTEXT NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, favorite_cities JSON NOT NULL COMMENT \'(DC2Type:json_array)\', email_address VARCHAR(255) NOT NULL, address VARCHAR(150) NOT NULL, postal_code VARCHAR(15) DEFAULT NULL, city VARCHAR(50) NOT NULL, country VARCHAR(2) NOT NULL, phone VARCHAR(35) DEFAULT NULL COMMENT \'(DC2Type:phone_number)\', profession VARCHAR(255) NOT NULL, custom_favorite_theme LONGTEXT DEFAULT NULL, uuid CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
