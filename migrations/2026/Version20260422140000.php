...
final class Version20260422140000 extends AbstractMigration
{
    ...
    {
        $this->addSql(<<<'SQL'
                CREATE TABLE app_user_activity_history (
            ...
            SQL);
        $this->addSql(<<<'SQL'
                ALTER TABLE app_user_activity_history
    ...
    {
        $this->addSql('ALTER TABLE app_user_activity_history DROP FOREIGN KEY FK_APP_USER_ACTIVITY_HISTORY_ADHERENT');
        $this->addSql('DROP TABLE app_user_activity_history');
    }
}
