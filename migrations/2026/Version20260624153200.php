...
final class Version20260624153200 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        $this->addSql('ALTER TABLE pronostic DROP FOREIGN KEY FK_E64BDCDE3DA5256D');
        $this->addSql('ALTER TABLE pronostic ADD CONSTRAINT FK_E64BDCDE3DA5256D FOREIGN KEY (image_id) REFERENCES uploadable_file (id)');
    }
