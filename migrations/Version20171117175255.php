...
class Version20171117175255 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE citizen_action_categories (id INT UNSIGNED AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL, status VARCHAR(10) DEFAULT \'ENABLED\' NOT NULL, UNIQUE INDEX citizen_action_category_name_unique (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE group_feed_items (id INT UNSIGNED AUTO_INCREMENT NOT NULL, group_id INT UNSIGNED DEFAULT NULL, author_id INT UNSIGNED DEFAULT NULL, event_id INT UNSIGNED DEFAULT NULL, item_type VARCHAR(18) NOT NULL COLLATE utf8mb4_unicode_ci, content LONGTEXT DEFAULT NULL COLLATE utf8mb4_unicode_ci, published TINYINT(1) DEFAULT \'1\' NOT NULL, created_at DATETIME NOT NULL, uuid CHAR(36) NOT NULL COLLATE utf8mb4_unicode_ci COMMENT \'(DC2Type:uuid)\', INDEX IDX_C35CDB43FE54D947 (group_id), INDEX IDX_C35CDB43F675F31B (author_id), INDEX IDX_C35CDB4371F7E88B (event_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE group_memberships (id INT UNSIGNED AUTO_INCREMENT NOT NULL, adherent_id INT UNSIGNED DEFAULT NULL, group_uuid CHAR(36) NOT NULL COLLATE utf8mb4_unicode_ci COMMENT \'(DC2Type:uuid)\', privilege VARCHAR(15) NOT NULL COLLATE utf8mb4_unicode_ci, joined_at DATETIME NOT NULL, uuid CHAR(36) NOT NULL COLLATE utf8mb4_unicode_ci COMMENT \'(DC2Type:uuid)\', UNIQUE INDEX adherent_has_joined_group (adherent_id, group_uuid), INDEX IDX_A3E258B725F06C53 (adherent_id), INDEX groups_memberships_role_idx (privilege), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE groups (id INT UNSIGNED AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, canonical_name VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, slug VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, description LONGTEXT NOT NULL COLLATE utf8mb4_unicode_ci, status VARCHAR(20) NOT NULL COLLATE utf8mb4_unicode_ci, approved_at DATETIME DEFAULT NULL, refused_at DATETIME DEFAULT NULL, created_by CHAR(36) DEFAULT NULL COLLATE utf8mb4_unicode_ci COMMENT \'(DC2Type:uuid)\', phone VARCHAR(35) DEFAULT NULL COLLATE utf8mb4_unicode_ci COMMENT \'(DC2Type:phone_number)\', members_counts SMALLINT UNSIGNED NOT NULL, uuid CHAR(36) NOT NULL COLLATE utf8mb4_unicode_ci COMMENT \'(DC2Type:uuid)\', created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, address_address VARCHAR(150) DEFAULT NULL COLLATE utf8mb4_unicode_ci, address_postal_code VARCHAR(15) DEFAULT NULL COLLATE utf8mb4_unicode_ci, address_city_insee VARCHAR(15) DEFAULT NULL COLLATE utf8mb4_unicode_ci, address_city_name VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci, address_country VARCHAR(2) DEFAULT NULL COLLATE utf8mb4_unicode_ci, address_latitude FLOAT (10,6) DEFAULT NULL COMMENT \'(DC2Type:geo_point)\', address_longitude FLOAT (10,6) DEFAULT NULL COMMENT \'(DC2Type:geo_point)\', UNIQUE INDEX group_uuid_unique (uuid), UNIQUE INDEX group_canonical_name_unique (canonical_name), UNIQUE INDEX group_slug_unique (slug), INDEX group_status_idx (status), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE mooc_event_categories (id INT UNSIGNED AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL COLLATE utf8mb4_unicode_ci, status VARCHAR(10) DEFAULT \'ENABLED\' NOT NULL COLLATE utf8mb4_unicode_ci, UNIQUE INDEX mooc_event_category_name_unique (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
