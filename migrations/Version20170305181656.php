...
class Version20170305181656 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE mailjet_emails (id INT UNSIGNED AUTO_INCREMENT NOT NULL, message_batch_uuid CHAR(36) NOT NULL COLLATE utf8mb4_unicode_ci COMMENT \'(DC2Type:uuid)\', subject VARCHAR(100) NOT NULL COLLATE utf8mb4_unicode_ci, recipient VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, template VARCHAR(10) NOT NULL COLLATE utf8mb4_unicode_ci, message_class VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci, request_payload LONGTEXT NOT NULL COLLATE utf8mb4_unicode_ci, request_payload_checksum VARCHAR(40) NOT NULL COLLATE utf8mb4_unicode_ci, response_payload LONGTEXT DEFAULT NULL COLLATE utf8mb4_unicode_ci, response_payload_checksum VARCHAR(40) DEFAULT NULL COLLATE utf8mb4_unicode_ci, delivered TINYINT(1) NOT NULL, sent_at DATETIME NOT NULL, uuid CHAR(36) NOT NULL COLLATE utf8mb4_unicode_ci COMMENT \'(DC2Type:uuid)\', UNIQUE INDEX mailjet_email_uuid (uuid), INDEX mailjet_email_message_batch_uuid (message_batch_uuid), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
