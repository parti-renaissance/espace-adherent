...
final class Version20200319171717 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE elected_representative_zone_category (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE elected_representative_zone (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_C52FC4A712469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE elected_representative_mandate ADD geographical_area VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, DROP zone_id');
