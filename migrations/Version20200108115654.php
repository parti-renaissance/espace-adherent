...
final class Version20200108115654 extends AbstractMigration
{
...
SQL
        ...
        $this->addSql('ALTER TABLE donators ADD CONSTRAINT FK_A902FDD7DE59CB1A FOREIGN KEY (last_successful_donation_id) REFERENCES donations (id) ON DELETE CASCADE');
