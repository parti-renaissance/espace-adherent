...
final class Version20201030104208 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE candidate_managed_area (id INT UNSIGNED AUTO_INCREMENT NOT NULL, zone_id INT UNSIGNED DEFAULT NULL, INDEX IDX_C604D2EA9F2C3FAB (zone_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
