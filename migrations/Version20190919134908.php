...
final class Version20190919134908 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE donations ADD type VARCHAR(255) DEFAULT NULL, CHANGE email_address email_address VARCHAR(255) DEFAULT NULL, ADD check_number VARCHAR(255) DEFAULT NULL, ADD transfer_number VARCHAR(255) DEFAULT NULL');
    ...
    {
        $this->addSql('ALTER TABLE donation_transactions ADD type VARCHAR(255) NOT NULL DEFAULT \'cb\' COLLATE utf8mb4_unicode_ci');
        $this->addSql('ALTER TABLE donations DROP type, CHANGE email_address email_address VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, DROP check_number, DROP transfer_number');
        ...
        $this->addSql('ALTER TABLE donators CHANGE email_address email_address VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
    }
}
