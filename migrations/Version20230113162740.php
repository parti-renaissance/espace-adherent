...
final class Version20230113162740 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        ADD
          CONSTRAINT FK_F304FF35E47E35 FOREIGN KEY (referent_id) REFERENCES adherents (id) ON UPDATE NO ACTION ON DELETE CASCADE');
        ...
        ADD
          ...
          ) REFERENCES municipal_manager_supervisor_role (id) ON UPDATE NO ACTION ON DELETE
        SET
          NULL');
