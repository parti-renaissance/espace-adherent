...
class Version20171129011217 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE citizen_project_categories (id INT UNSIGNED AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL, status VARCHAR(10) DEFAULT \'ENABLED\' NOT NULL, UNIQUE INDEX citizen_project_category_name_unique (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE citizen_projects ADD description LONGTEXT NOT NULL COLLATE utf8mb4_unicode_ci, DROP category_id, DROP committee_id, DROP subtitle, DROP problem_description, DROP proposed_solution, DROP required_means, DROP assistance_needed, DROP assistance_content');
    }
}
