...
class Version20180124092336 extends AbstractMigration
{
    ...
    {
        $this->addSql('ALTER TABLE oauth_clients CHANGE supported_scopes supported_scopes LONGTEXT NOT NULL COLLATE utf8mb4_unicode_ci COMMENT \'(DC2Type:simple_array)\'');
    }
}
