...
class Version20170810154040 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE citizen_initiative_categories (id INT UNSIGNED AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL, UNIQUE INDEX citizen_initiative_category_name_unique (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
