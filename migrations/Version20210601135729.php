...
final class Version20210601135729 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ideas_workshop_idea (
          ...
          author_category VARCHAR(9) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`,
        ...
        $this->addSql('CREATE TABLE ideas_workshop_question (
          ...
          placeholder VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`,
          position SMALLINT UNSIGNED NOT NULL,
          name VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`,
          required TINYINT(1) NOT NULL,
          enabled TINYINT(1) NOT NULL,
          category VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`,
        ...
        $this->addSql('CREATE TABLE ideas_workshop_theme (
          ...
          enabled TINYINT(1) NOT NULL,
          name VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`,
          image_name VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`,
          position SMALLINT UNSIGNED NOT NULL,
        ...
        ADD
          ideas_workshop_link VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE
          reports
        ADD
