...
class Version20170503015627 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE event_invitations (id INT UNSIGNED AUTO_INCREMENT NOT NULL, event_id INT UNSIGNED DEFAULT NULL, email VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, message VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, client_ip VARCHAR(50) DEFAULT NULL COLLATE utf8mb4_unicode_ci, created_at DATETIME NOT NULL, uuid CHAR(36) NOT NULL COLLATE utf8mb4_unicode_ci COMMENT \'(DC2Type:uuid)\', first_name VARCHAR(50) NOT NULL COLLATE utf8mb4_unicode_ci, last_name VARCHAR(50) NOT NULL COLLATE utf8mb4_unicode_ci, INDEX IDX_88AEC32E71F7E88B (event_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
