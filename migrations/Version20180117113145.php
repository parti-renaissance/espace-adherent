...
class Version20180117113145 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE citizen_initiative_categories (id INT UNSIGNED AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL COLLATE utf8mb4_unicode_ci, status VARCHAR(10) DEFAULT \'ENABLED\' NOT NULL COLLATE utf8mb4_unicode_ci, UNIQUE INDEX citizen_initiative_category_name_unique (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE events ADD citizen_initiative_category_id INT UNSIGNED DEFAULT NULL, ADD interests JSON DEFAULT NULL COLLATE utf8mb4_unicode_ci COMMENT \'(DC2Type:json_array)\', ADD expert_assistance_needed TINYINT(1) DEFAULT \'0\', ADD coaching_requested TINYINT(1) DEFAULT \'0\', ADD coaching_request_problem_description VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci, ADD coaching_request_proposed_solution VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci, ADD coaching_request_required_means VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci, ADD expert_found TINYINT(1) DEFAULT \'0\' NOT NULL, ADD was_published TINYINT(1) DEFAULT \'0\', ADD place VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci');
