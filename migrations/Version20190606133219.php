...
final class Version20190606133219 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        $this->addSql('CREATE TABLE application_request_theme (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE application_request_technical_skill (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE application_request_volunteer (id INT UNSIGNED AUTO_INCREMENT NOT NULL, custom_technical_skills VARCHAR(255) DEFAULT NULL, is_previous_campaign_member TINYINT(1) NOT NULL, previous_campaign_details LONGTEXT DEFAULT NULL, share_associative_commitment TINYINT(1) NOT NULL, associative_commitment_details LONGTEXT DEFAULT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, favorite_cities JSON NOT NULL COMMENT \'(DC2Type:json_array)\', email_address VARCHAR(255) NOT NULL, address VARCHAR(150) NOT NULL, postal_code VARCHAR(15) DEFAULT NULL, city VARCHAR(20) DEFAULT NULL, city_name VARCHAR(50) NOT NULL, country VARCHAR(2) NOT NULL, phone VARCHAR(35) DEFAULT NULL COMMENT \'(DC2Type:phone_number)\', profession VARCHAR(255) NOT NULL, custom_favorite_theme LONGTEXT DEFAULT NULL, uuid CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE volunteer_request_referent_tag (volunteer_request_id INT UNSIGNED NOT NULL, referent_tag_id INT UNSIGNED NOT NULL, INDEX IDX_DA291742B8D6887 (volunteer_request_id), INDEX IDX_DA2917429C262DB3 (referent_tag_id), PRIMARY KEY(volunteer_request_id, referent_tag_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE application_request_running_mate (id INT UNSIGNED AUTO_INCREMENT NOT NULL, curriculum_name VARCHAR(255) NOT NULL, is_local_association_member TINYINT(1) NOT NULL, local_association_domain LONGTEXT DEFAULT NULL, is_political_activist TINYINT(1) NOT NULL, political_activist_details LONGTEXT DEFAULT NULL, is_previous_elected_official TINYINT(1) NOT NULL, previous_elected_official_details LONGTEXT DEFAULT NULL, favorite_theme_details LONGTEXT NOT NULL, project_details LONGTEXT NOT NULL, professional_assets LONGTEXT NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, favorite_cities JSON NOT NULL COMMENT \'(DC2Type:json_array)\', email_address VARCHAR(255) NOT NULL, address VARCHAR(150) NOT NULL, postal_code VARCHAR(15) DEFAULT NULL, city VARCHAR(20) DEFAULT NULL, city_name VARCHAR(50) NOT NULL, country VARCHAR(2) NOT NULL, phone VARCHAR(35) DEFAULT NULL COMMENT \'(DC2Type:phone_number)\', profession VARCHAR(255) NOT NULL, custom_favorite_theme LONGTEXT DEFAULT NULL, uuid CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE running_mate_request_referent_tag (running_mate_request_id INT UNSIGNED NOT NULL, referent_tag_id INT UNSIGNED NOT NULL, INDEX IDX_53AB4FABCEDF4387 (running_mate_request_id), INDEX IDX_53AB4FAB9C262DB3 (referent_tag_id), PRIMARY KEY(running_mate_request_id, referent_tag_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE volunteer_request_referent_tag ADD CONSTRAINT FK_DA291742B8D6887 FOREIGN KEY (volunteer_request_id) REFERENCES application_request_volunteer (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE volunteer_request_referent_tag ADD CONSTRAINT FK_DA2917429C262DB3 FOREIGN KEY (referent_tag_id) REFERENCES referent_tags (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE running_mate_request_referent_tag ADD CONSTRAINT FK_53AB4FABCEDF4387 FOREIGN KEY (running_mate_request_id) REFERENCES application_request_running_mate (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE running_mate_request_referent_tag ADD CONSTRAINT FK_53AB4FAB9C262DB3 FOREIGN KEY (referent_tag_id) REFERENCES referent_tags (id) ON DELETE CASCADE');
    }
