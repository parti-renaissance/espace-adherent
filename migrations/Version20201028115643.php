...
final class Version20201028115643 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE adherent_zone (adherent_id INT UNSIGNED NOT NULL, zone_id INT UNSIGNED NOT NULL, INDEX IDX_1C14D08525F06C53 (adherent_id), INDEX IDX_1C14D0859F2C3FAB (zone_id), PRIMARY KEY(adherent_id, zone_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
