    ...
    render() {
        ...
        return (
            <div className="amount-chooser">
                ...
                <h3>Don recurrent</h3>
                <div className="text--left">En cochant la case ci-dessous, vous acceptez de mensualiser ce don. Votre carte bancaire sera débitée tous les mois. Vous pouvez annuler ce don mensuel à tout moment depuis votre espace adhérent ou en nous contactant.</div>
