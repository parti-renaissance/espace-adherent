...
export default (formType) => {
    ...
    const emailField = dom('#renaissance_adherent_registration_emailAddress_first');
    const confirmEmailField = dom('#renaissance_adherent_registration_emailAddress_second');
