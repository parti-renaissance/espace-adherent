Feature:
  ...
  Scenario: I can see running mate request only for the zones I manage
    ...
    Then I should see "Vous gérez : Lille, Seclin, Oignies"
    And I should see 3 "tr" in the 1st "table.datagrid__table-manager tbody"
    And I should see "Lille, Camphin-en-Carembault"
    And I should see "Seclin, Mons-en-Pévèle"
  ...
  Scenario Outline: I can see running mate request only for the zones I manage
    ...
    Examples:
      ...
      | municipal-chief-2@en-marche-dev.fr | Vous gérez : Camphin-en-Carembault, Camphin-en-Pévèle | Lille, Camphin-en-Carembault       | Mons-en-Baroeul, Camphin-en-Pévèle |
      | municipal-chief-3@en-marche-dev.fr | Vous gérez : Mons-en-Pévèle, Mons-en-Baroeul          | Mons-en-Baroeul, Camphin-en-Pévèle | Seclin, Mons-en-Pévèle             |
