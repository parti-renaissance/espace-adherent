Feature:
  ...
  Scenario Outline: Publish message on user created|updated
    ...
    And "api_sync" should have message below:
      | routing_key   | body                                                                                                                                                                                                                                |
      | <routing_key> | {"uuid":"313bd28f-efc8-57c9-8ab7-2106c8be9697","subscriptionExternalIds":["123abc","456def"],"country":"CH","zipCode":"8057","tags":["CH"],"emailAddress":"michelle.dufour@example.ch","firstName":"Michelle","lastName":"Dufour"}  |
    Examples:
      | event        | routing_key  |
  ...
  Scenario: Publish message on user deleted
    ...
    And "api_sync" should have message below:
      | routing_key  | body                                                                                                                                                                                                                             |
      | user.deleted | {"uuid":"46ab0600-b5a0-59fc-83a7-cc23ca459ca0","subscriptionExternalIds":["123abc","456def"],"country":"CH","zipCode":"8802","tags":["CH"],"emailAddress":"michel.vasseur@example.ch","firstName":"Michel","lastName":"VASSEUR"} |
  ...
  Scenario Outline: Publish message on citizen project created|updated
    ...
    And "api_sync" should have message below:
      | routing_key   | body                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
      | <routing_key> | {"uuid":"aa364092-3999-4102-930c-f711ef971195","status":"APPROVED","membersCount":4,"name":"Le projet citoyen \u00e0 Paris 8","slug":"75008-le-projet-citoyen-a-paris-8","category":"Nature et Environnement","longitude":2.303243,"latitude":48.870506,"country":"FR","address":"60 avenue des Champs-\u00c9lys\u00e9es","zipCode":"75008","city":"Paris 8e","tags":["75008","75"],"subtitle":"Le projet citoyen des habitants du 8\u00e8me arrondissement de Paris.","district":"Paris 8e","author":"Jacques P.","thumbnail":"http:\/\/test.enmarche.code\/assets\/images\/citizen_projects\/default.png"} |
    Examples:
      | event                   | routing_key             |
