...
Feature:
  ...
  Scenario: As a non logged-in user I can see quick actions of the cause
    Given I send a "GET" request to "/api/causes/55056e7c-2b5f-4ef6-880e-cde0511f79b2/quick_actions?page_size=3"
  ...
  Scenario: As a logged-in user I can modify quick actions of the cause
    And I send a "GET" request to "/api/causes/55056e7c-2b5f-4ef6-880e-cde0511f79b2/quick_actions?page_size=3"
    Then the response status code should be 200
    And the JSON should be equal to:
    """
    {
