            ...
            [
                {
                    ...
                    "filters": [
                        ...
                        },
                        {
                            ...
                            "options": {
                                "url": "/api/v3/zone/autocomplete?types%5B0%5D=borough&types%5B1%5D=canton&types%5B2%5D=city&types%5B3%5D=district&types%5B4%5D=country",
                                "query_param": "q",
                                "value_param": "uuid",
                                "label_param": "name",
                                "multiple": false,
                    ...
                    "filters": [
                        {
                            ...
                            "options": {
                                "instances": [
                                    ...
                                    {
                                        "code": "national_elected_representatives_division",
                                        "main_role": "Chef de pôle",
                                        "name": "Pôle Élus",
                                        "team_roles": [
                                            {
                                    ...
                                    {
                                        "code": "national_formation_division",
                                        "main_role": "Chef de pôle",
