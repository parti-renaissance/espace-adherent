    ...
    Scenario Outline: As a user with role on Vox app I can get adherent detail with split tags
        ...
        And the JSON should be equal to:
            """
            {
                ...
                "roles": [
                    {"code": "president_departmental_assembly", "label": "Responsable communication (75, 77)", "is_delegated": true, "function": "Responsable communication", "zones": "Paris, Seine-et-Marne", "zone_codes": "75, 77", "delegator": {"first_name": "Referent75and77", "last_name": "Referent75and77", "role": "Présidente d'Assemblée (75, 77)"}}
                ],
    ...
    Scenario Outline: As a user with role on Vox app I can get adherent detail with multiple delegated roles
        ...
        And the JSON should be equal to:
            """
            {
                ...
                "roles": [
                    {"code": "legislative_candidate", "label": "Responsable communication (75-1)", "is_delegated": true, "function": "Responsable communication", "zones": "Paris (1)", "zone_codes": "75-1", "delegator": {"first_name": "Jean-Baptiste", "last_name": "Fortin", "role": "Candidat aux législatives (75-1)"}},
                    {"code": "president_departmental_assembly", "label": "Responsable élus délégué #1 (92)", "is_delegated": true, "function": "Responsable élus délégué #1", "zones": "Hauts-de-Seine", "zone_codes": "92", "delegator": {"first_name": "Damien", "last_name": "Durock", "role": "Président d'Assemblée (92)"}},
                    {"code": "president_departmental_assembly", "label": "Responsable communication (13, 59, 76, 77, 92)", "is_delegated": true, "function": "Responsable communication", "zones": "Bouches-du-Rhône, Hauts-de-Seine, Nord, Seine-Maritime, Seine-et-Marne", "zone_codes": "13, 59, 76, 77, 92", "delegator": {"first_name": "Referent", "last_name": "Referent", "role": "Président d'Assemblée (13, 59, 76, 77, 92)"}},
                    {"code": "deputy", "label": "Responsable mobilisation (CIRCO_FDE-06)", "is_delegated": true, "function": "Responsable mobilisation", "zones": "Suisse", "zone_codes": "CIRCO_FDE-06", "delegator": {"first_name": "Député", "last_name": "CHLI FDESIX", "role": "Délégué de circonscription (CIRCO_FDE-06)"}},
                    {"code": "deputy", "label": "Responsable mobilisation (75-2)", "is_delegated": true, "function": "Responsable mobilisation", "zones": "Paris (2)", "zone_codes": "75-2", "delegator": {"first_name": "Député", "last_name": "PARIS II", "role": "Délégué de circonscription (75-2)"}},
                    {"code": "senator", "label": "Responsable mobilisation (92)", "is_delegated": true, "function": "Responsable mobilisation", "zones": "Hauts-de-Seine", "zone_codes": "92", "delegator": {"first_name": "Bob", "last_name": "Senateur (59)", "role": "Sénateur (92)"}},
                    {"code": "candidate", "label": "Candidat délégué", "is_delegated": true, "function": "Candidat délégué", "zones": null, "zone_codes": null, "delegator": {"first_name": "Jacques", "last_name": "Picard", "role": "Candidat"}},
                    {"code": "correspondent", "label": "Responsable logistique (92)", "is_delegated": true, "function": "Responsable logistique", "zones": "Hauts-de-Seine", "zone_codes": "92", "delegator": {"first_name": "Jules", "last_name": "Fullstack", "role": "Responsable local (92)"}}
                ],
                "available_for_resubscribe_email": false
            }
            """
            ...
            """
            {
                ...
                "items": [
                    ...
                    },
                    {
                        ...
                        "roles": [
                            {"code": "correspondent", "label": "Responsable local (92)", "is_delegated": false, "function": null, "zones": "Hauts-de-Seine", "zone_codes": "92", "delegator": null}
                        ]
                    },
                    {
                        "uuid": "b4219d47-3138-5efd-9762-2ef9f9495084",
