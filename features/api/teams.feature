...
Feature:
  ...
  Scenario: As a logged-in user I can not get phoning teams
    Given I am logged with "jacques.picard@en-marche.fr" via OAuth client "Data-Corner"
    When I send a "GET" request to "/api/v3/teams/phoning?scope=phoning_national_manager"
    Then the response status code should be 403

  Scenario: As a logged-in user I can get phoning teams
