...
Feature:
  ...
  Scenario: As a logged-in user I can add my vote to an idea
    ...
    And I send a "POST" request to "/api/ideas-workshop/votes" with body:
    """
    {
  ...
  Scenario: As a non logged-in user I can not delete a vote
    When I send a "DELETE" request to "/api/ideas-workshop/votes/1"
    Then the response status code should be 401

  Scenario: As a logged-in user I can not delete a vote that is not mine
    When I am logged as "jacques.picard@en-marche.fr"
    And I send a "DELETE" request to "/api/ideas-workshop/votes/1"
    Then the response status code should be 403

  Scenario: As a logged-in user I can delete my vote
    When I am logged as "jacques.picard@en-marche.fr"
    And I send a "DELETE" request to "/api/ideas-workshop/votes/10"
