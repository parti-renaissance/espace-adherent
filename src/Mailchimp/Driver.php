...
class Driver implements LoggerAwareInterface
{
    ...
    public function createCampaign(EditCampaignRequest $request): ?string
    {
    ...
    public function updateCampaign(string $campaignId, EditCampaignRequest $request): bool
    {
        return $this->sendRequest('PATCH', sprintf('/campaigns/%s', $campaignId), $request->toArray());
    }
