...
final class ProcurationProxyReminderMail extends TransactionalMail
{
    public const SUBJECT = 'RAPPEL : votre procuration';

    public static function createRecipient(ProcurationRequest $request, string $url): RecipientInterface
    {
        return new Recipient($request->getEmailAddress(), null, self::createTemplateVars($request, $url));
    }
