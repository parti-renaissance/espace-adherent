...
final class DonationMail extends TransactionalMail
{
    public const SUBJECT = 'Merci pour votre engagement';

    public static function createRecipient(Donation $donation): RecipientInterface
    {
