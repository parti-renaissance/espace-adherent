...
use App\Mailer\Message\Renaissance\DepartmentalElectionCandidateInvitationMessage;
...
class SendCandidatureInvitationForDepartmentalElectionsCommand extends Command
{
    ...
    protected static $defaultName = 'app:departmental-election:send-candidature-invitation';
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        while (
            ...
            if ($this->transactionalMailer->sendMessage(DepartmentalElectionCandidateInvitationMessage::create($adherents))) {
                if (!$selectedEmails) {
