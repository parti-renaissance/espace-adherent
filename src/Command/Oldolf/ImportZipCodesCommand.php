...
use AppBundle\Repository\Oldolf\DepartmentRepository;
use AppBundle\Repository\Oldolf\RegionRepository;
...
class ImportZipCodesCommand extends AbstractImportCommand
{
    ...
    {
        $this->setDescription('Import OLDOLF zipcodes from CSV files');
    }

    protected function execute(InputInterface $input, OutputInterface $output)
    {
        $this->io->title('OLDOLF zipcodes import.');
        ...
        $this->io->success('OLDOLF zipcodes imported successfully!');
    }
