...
class BaseEventInvitationType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->addEventListener(FormEvents::POST_SUBMIT, function (FormEvent $event) {
                ...
                if (!$invitation instanceof BaseEventInvitation) {
                    throw new UnexpectedTypeException($invitation, BaseEventInvitation::class);
                }
