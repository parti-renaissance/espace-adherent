...
class PlatformMembershipRequest extends AbstractMembershipRequest implements RecaptchaChallengeInterface, MembershipCustomGenderInterface
{
    ...
    #[Assert\Choice(callback: ['App\ValueObject\Genders', 'all'], message: 'common.gender.invalid_choice', strict: true, groups: ['Update'])]
    public $gender;
    ...
    #[Assert\Length(min: 2, max: 50, allowEmptyString: true, minMessage: 'common.first_name.min_length', maxMessage: 'common.first_name.max_length', groups: ['Registration', 'Update'])]
     ...
     */
    #[Assert\NotBlank(groups: ['Registration', 'Update'])]
    #[Assert\Length(min: 1, max: 50, allowEmptyString: true, minMessage: 'common.last_name.min_length', maxMessage: 'common.last_name.max_length', groups: ['Registration', 'Update'])]
    public $lastName;
     ...
     * @var string|null
     */
    #[Assert\Choice(callback: ['App\Membership\ActivityPositionsEnum', 'all'], message: 'adherent.activity_position.invalid_choice', strict: true, groups: ['Update'])]
    public $position;
