...
class OldolfMeasurePayloadValidator extends ConstraintValidator
{
    ...
    {
        if (!$constraint instanceof OldolfMeasurePayload) {
            throw new UnexpectedTypeException($constraint, OldolfMeasurePayload::class);
        }
