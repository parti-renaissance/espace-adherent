...
class GroupMembershipException extends \RuntimeException
{
    ...
    public static function createNotPromotableAdministratorPrivilegeException(UuidInterface $membershipUuid, \Exception $previous = null): self
    {
        return new self(
            $membershipUuid,
            sprintf('Group membership "%s" cannot be promoted to the administrator privilege.', $membershipUuid),
            $previous
        );
    }
    ...
    public static function createNotDemotableFollowerPrivilegeException(UuidInterface $membershipUuid, \Exception $previous = null): self
    {
        return new self(
            $membershipUuid,
            sprintf('Group membership "%s" cannot be demoted to the simple follower.', $membershipUuid),
            $previous
        );
    }
