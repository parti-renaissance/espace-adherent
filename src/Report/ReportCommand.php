...
class ReportCommand
{
    ...
    #[Assert\Choice(choices: ReportReasonEnum::REASONS_LIST, strict: true, multiple: true, multipleMessage: 'report.invalid_reasons', min: 1, minMessage: 'report.invalid_reasons')]
    private $reasons = [];
