...
class GroupAdmin extends AbstractAdmin
{
    ...
    public function __construct($code, $class, $baseControllerName, GroupManager $manager, ObjectManager $om)
    {
        parent::__construct($code, $class, $baseControllerName);

        $this->manager = $manager;
        $this->groupMembershipRepository = $om->getRepository(GroupMembership::class);
    }
        ...
        $formMapper
            ...
            ->with('Localisation', array('class' => 'col-md-5'))
                ...
                ->add('postAddress.longitude', null, [
                    ...
                    'empty_data' => null,
                    'label' => 'Longitude',
                    'help' => 'Pour modifier l\'adresse, impersonnifiez un administrateur de cet équipe MOOC.',
                ])
            ->end()
        ;
    }
