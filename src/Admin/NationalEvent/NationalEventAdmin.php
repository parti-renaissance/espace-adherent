        ...
        $form
            ...
            ->tab('Formulaire d\'inscription 📋')
                ...
                ->with('Personnalisation des labels', ['class' => 'col-md-6', 'description' => 'Laissez vide pour utiliser le label par défaut (affiché en placeholder).'])
                    ...
                    ->add('labelIsJAM', TextType::class, ['label' => 'Label : JAM', 'required' => false, 'attr' => ['placeholder' => 'Je suis membre des Jeunes en marche']])
                    ...
                    ->add('labelEmergencyContact', TextType::class, ['label' => 'Label : Contact d\'urgence', 'required' => false, 'attr' => ['placeholder' => 'Contact en cas d\'urgence (obligatoire)']])
