...
final class VotingPlatformVoteStatusesIsOpenMessage extends AbstractVotingPlatformMessage
{
    /**
    ...
    public static function create(Election $election, array $adherents, string $url): self
    {
        ...
        $message = new self(
            ...
            [
                'vote_end_date' => static::formatDate($election->getVoteEndDate(), 'EEEE d MMMM y à HH\'h\'mm'),
                'page_url' => $url,
            ]
        );
