    ...
    public function findOneCampaignByZone(Zone $region, Zone $department, string $postalCode): ?Region
    {
        ...
        return $qb
            ...
            ->setParameters(new ArrayCollection([
                new Parameter('code_france', AddressInterface::FRANCE),
                new Parameter('region', $region),
                new Parameter('department', $department),
                new Parameter('postal_code', $postalCode),
                new Parameter('zone_country', Zone::COUNTRY),
                new Parameter('zone_region', Zone::REGION),
                new Parameter('zone_department', Zone::DEPARTMENT),
                new Parameter('zone_borough', Zone::BOROUGH),
