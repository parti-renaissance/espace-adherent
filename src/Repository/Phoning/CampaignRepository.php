...
/**
 * @extends \Doctrine\Bundle\DoctrineBundle\Repository\ServiceEntityRepository<\App\Entity\Phoning\Campaign>
 */
class CampaignRepository extends ServiceEntityRepository
{
    ...
    public function findForAdherent(Adherent $adherent): array
    {
        return $this->createQueryBuilder('campaign')
            ...
            ->setParameters(new ArrayCollection([new Parameter('adherent', $adherent), new Parameter('send', CampaignHistoryStatusEnum::SEND), new Parameter('now', new \DateTime()), new Parameter('true', true)]))
    ...
    public function findPhoningCampaignsKpi(array $zones = []): array
    {
        $queryBuilder = $this->createQueryBuilder('campaign')
            ...
            ->setParameters(new ArrayCollection([new Parameter('now', new \DateTime()), new Parameter('last_30d', new \DateTime('-30 days')), new Parameter('send', CampaignHistoryStatusEnum::SEND)]))
        ;
