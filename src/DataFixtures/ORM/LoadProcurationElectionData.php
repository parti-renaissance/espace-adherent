...
class LoadProcurationElectionData extends Fixture
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $this->setReference('procuration-europeennes-2024-round-1', $round);
        ...
        $election2->addRound($round2 = $this->createRound(
            'Deuxième tour',
            new \DateTimeImmutable('+21 days')->format('Y-m-d'),
            Uuid::fromString(self::UUID_LEGISLATIVES_ROUND_2)
        ));

        $manager->persist($election2);
        $this->setReference('procuration-legislatives-2024-round-1', $round1);
        $this->setReference('procuration-legislatives-2024-round-2', $round2);
