...
class LoadGroupData extends AbstractFixture implements FixtureInterface, ContainerAwareInterface, DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $group4 = $groupFactory->createFromArray([
            ...
            'description' => 'Encore un équipe MOOC',
        ]);
        $group4->approved();
        ...
        $group5 = $groupFactory->createFromArray([
            ...
            'description' => 'Equipe de la formation en ligne ouverte à tous à Évry',
        ...
        $group6 = $groupFactory->createFromArray([
            ...
            'description' => 'Equipe de la formation en ligne ouverte à tous',
            'phone' => '33 234823644',
        ]);
        ...
        $group7 = $groupFactory->createFromArray([
            ...
            'name' => 'Equipe MOOC à Berlin',
            'description' => 'Equipe MOOC de nos partenaires Allemands.',
        ]);
        ...
        $group9 = $groupFactory->createFromArray([
            ...
            'description' => 'Equipe MOOC à New York City.',
