...
class LoadReferentTagData extends Fixture
{
    public function load(ObjectManager $manager)
    {
        ...
        $this->createReferentTag($manager, 'Métropole de Lyon', '69M', ReferentTag::TYPE_METROPOLIS);
        $this->createReferentTag($manager, 'Métropole de Montpellier', '34M', ReferentTag::TYPE_METROPOLIS);
