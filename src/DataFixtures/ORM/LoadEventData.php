...
class LoadEventData extends AbstractLoadEventData implements DependentFixtureInterface
{
    ...
    public function loadEvents(ObjectManager $manager): void
    {
        ...
        $event1->setBeginAt(new \DateTimeImmutable('now')->modify('+1 hour'));
        $event1->setFinishAt(new \DateTimeImmutable('now')->modify('+2 hours'));
        ...
        $event2->setBeginAt(new \DateTimeImmutable('now')->modify('+2 hours'));
        $event2->setFinishAt(new \DateTimeImmutable('now')->modify('+3 hours'));
        ...
        $event3->setBeginAt(new \DateTimeImmutable('now')->modify('-2 hours'));
        $event3->setFinishAt(new \DateTimeImmutable('now')->modify('-1 hour'));
        ...
        $event4->setBeginAt(new \DateTimeImmutable('now')->modify('+2 hours'));
        $event4->setFinishAt(new \DateTimeImmutable('now')->modify('+4 hours'));
        ...
        $event5->setBeginAt(new \DateTimeImmutable('now')->modify('-3 hours'));
        $event5->setFinishAt(new \DateTimeImmutable('now')->modify('-2 hour'));
        ...
        $event6->setBeginAt(new \DateTimeImmutable('now')->modify('+6 hours'));
        $event6->setFinishAt(new \DateTimeImmutable('now')->modify('+8 hours'));
        ...
        $event7->setBeginAt(new \DateTimeImmutable('now')->modify('-2 months'));
        $event7->setFinishAt(new \DateTimeImmutable('now')->modify('-2 months'));
        ...
        $event8->setBeginAt(new \DateTimeImmutable('now')->modify('-2 months'));
        $event8->setFinishAt(new \DateTimeImmutable('now')->modify('-2 months'));
        ...
        for ($i = 1; $i <= 5; ++$i) {
            ...
            $event->setBeginAt(new \DateTimeImmutable('now')->modify('+2 hours'));
            $event->setFinishAt(new \DateTimeImmutable('now')->modify('+4 hours'));
