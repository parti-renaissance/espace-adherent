...
class LoadCitizenProjectData extends AbstractFixture implements FixtureInterface, ContainerAwareInterface, DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $citizenProject1->setDefaultImageName();
        ...
        $citizenProject2->setDefaultImageName();
        ...
        $citizenProject3->setDefaultImageName();
        ...
        $citizenProject4->setDefaultImageName();
        ...
        $citizenProject5->setDefaultImageName();
        ...
        $citizenProject6->setDefaultImageName();
        ...
        $citizenProject7->setDefaultImageName();
        ...
        $citizenProject8->setDefaultImageName();
        ...
        $citizenProject9->setDefaultImageName();
