...
class LoadProcurationRequestData extends Fixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        $manager->persist($this->createRequest(
            null,
            $rounds = [$this->getReference('procuration-europeennes-2024-round-1', Round::class)],
            'jack.doe@test.dev',
            Genders::MALE,
            'Jack, Didier',
            'Doe',
        ...
        $manager->persist($request = $this->createRequest(
            ...
            [$this->getReference('procuration-legislatives-2024-round-1', Round::class)],
            'jack.doe@test.dev',
            Genders::MALE,
            'Jack, Didier',
            'Doe',
        ...
        $manager->persist($this->createRequest(
            ...
            [$this->getReference('procuration-legislatives-2024-round-2', Round::class)],
            'pierre.doe@test.dev',
            Genders::MALE,
            'Pierre',
            'Doe',
        ...
        $manager->persist($this->createRequest(
            ...
            [
                $this->getReference('procuration-legislatives-2024-round-2', Round::class),
                $round1 = $this->getReference('procuration-legislatives-2024-round-1', Round::class),
            ],
            'chris.doe@test.dev',
            Genders::MALE,
            'Chris',
    ...
    public function getDependencies(): array
    {
        return [
            ...
            LoadProcurationElectionData::class,
            LoadProcurationProxyData::class,
        ];
    }
