...
class LoadTeamData extends Fixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $team1->setCreatedAt(new \DateTimeImmutable('-12 hours'));
        ...
        $team3->setCreatedAt(new \DateTimeImmutable('-8 hours'));
        ...
        $team4->setCreatedAt(new \DateTimeImmutable('-7 hours'));
        ...
        $team5->setCreatedAt(new \DateTimeImmutable('-7 hours'));
        ...
        $team->setCreatedAt(new \DateTimeImmutable('-8 hours'));
