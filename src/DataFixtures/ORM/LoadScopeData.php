...
class LoadScopeData extends Fixture
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $manager->persist($this->createScope(ScopeEnum::NATIONAL, 'National', array_diff(FeatureEnum::ALL, [FeatureEnum::MESSAGES, FeatureEnum::LOCAL_SITE])));
        ...
        $manager->persist($this->createScope(ScopeEnum::REGIONAL_COORDINATOR, 'Coordinateur régional', array_diff(FeatureEnum::ALL, [FeatureEnum::LOCAL_SITE])));
