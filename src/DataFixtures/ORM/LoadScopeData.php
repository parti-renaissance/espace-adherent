...
class LoadScopeData extends Fixture
{
    ...
    private function getFeatures(string $scopeCode): array
    {
        return match ($scopeCode) {
            ...
            ScopeEnum::MILITANT => [FeatureEnum::EVENTS, FeatureEnum::ACTIONS, FeatureEnum::AI_ANTISECHE, FeatureEnum::PAP_USER],
            ScopeEnum::PAP,
            ScopeEnum::MEETING_SCANNER,
            ScopeEnum::PHONING => [],
            ...
            ScopeEnum::LEGISLATIVE_CANDIDATE => array_merge(self::BASIC_FEATURES, [FeatureEnum::NEWS, FeatureEnum::PAP, FeatureEnum::MY_TEAM, FeatureEnum::PROCURATIONS]),
