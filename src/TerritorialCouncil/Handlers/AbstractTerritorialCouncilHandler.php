...
abstract class AbstractTerritorialCouncilHandler implements TerritorialCouncilMembershipHandlerInterface
{
    ...
    public function handle(Adherent $adherent): void
    {
        ...
        foreach ($actualMembership->getQualities() as $actualQuality) {
            ...
            if ('' !== $constraintMsg && !str_contains($msg, $constraintMsg)) {
    ...
    private function getRemovingConstraintsMsg(
        ...
        if (
            ...
            && ($committeeMandates = $this->committeeMandateRepository->findActiveCommitteeMandates(
                $adherent,
                $actualMembership->getTerritorialCouncil()->getReferentTags()->toArray()
            ))
