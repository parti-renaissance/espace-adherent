...
class EventGroupsContextBuilder implements SerializerContextBuilderInterface
{
    ...
    public function createFromRequest(Request $request, bool $normalization, ?array $extractedAttributes = null): array
    {
        ...
        if ($request->attributes->get(EventsFallbackProvider::CONTEXT_KEY)) {
            $context['groups'][] = 'event_list_read:region';
        }

        if (Request::METHOD_PUT !== $request->getMethod() || $normalization) {
            return $context;
        }
