...
/**
 * @Route("/v3/teams/{uuid}/members", requirements={"uuid": "%pattern_uuid%"}, name="api_team_add_members", methods={"PUT"})
 *
...
class AddTeamMembersController extends AbstractController
{
    public function __invoke(
        ...
        $teamMemberManagementHandler->handleChanges($team, $team->getMembers(), $newMembers);
