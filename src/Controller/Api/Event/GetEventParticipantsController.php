 ...
 */
#[Route(path: '/v3/events/{uuid}/participants.{_format}', name: 'api_events_get_participants', methods: ['GET'], requirements: ['uuid' => '%pattern_uuid%', '_format' => 'json|xls'], defaults: ['_format' => 'json'])]
