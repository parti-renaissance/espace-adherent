...
class CommitteeManagementAuthority
{
    ...
    public function approve(Committee $committee): void
    {
        ...
        $this->mailPost->address(
            ...
            CommitteeApprovalConfirmationMail::createRecipient($this->manager->getCommitteeCreator($committee)),
            null,
    ...
    public function notifyReferentsForApproval(Committee $committee): void
    {
        ...
        $this->mailPost->address(
            ...
            CommitteeApprovalReferentMail::createRecipient($referents->first()),
            null,
