...
class RegionalCoordinatorMailchimpCampaignHandler extends AbstractMailchimpCampaignHandler
{
    public function supports(AdherentMessageInterface $message): bool
    {
        return $message instanceof RegionalCoordinatorAdherentMessage && $message->getFilter() instanceof AudienceFilter;
    }
