...
use AppBundle\Mail\Campaign\CitizenActionCancellationMail;
use AppBundle\Mail\Campaign\CitizenActionNotificationMail;
    ...
    public function sendCancellationEmail(CitizenActionEvent $citizenActionEvent): void
    {
        ...
        if (\count($subscriptions) > 0) {
            $this->mailPost->address(
                ...
                CitizenActionCancellationMail::createTemplateVarsFrom($citizenAction, $this->generateUrl('app_search_events')),
