...
class AdherentDelegatedAccessesExtension extends AbstractExtension
{
    ...
    public function getFirstAccessRoute(DelegatedAccess $delegatedAccess): string
    {
        $routes = [
            ...
            DelegatedAccess::ACCESS_COMMITTEE => "app_{$delegatedAccess->getType()}_delegated_committees",
            DelegatedAccess::ACCESS_CITIZEN_PROJECTS => "app_{$delegatedAccess->getType()}_citizen_projects_delegated_list",
            DelegatedAccess::ACCESS_JECOUTE => "app_jecoute_{$delegatedAccess->getType()}_delegated_local_surveys_list",
