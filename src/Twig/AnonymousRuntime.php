...
class AnonymousRuntime implements RuntimeExtensionInterface
{
    ...
    private const USER_REGISTER_ROUTE = 'app_membership_register';
    ...
    private function doGeneratePathForAnonymousFollower(string $intention, string $callbackRoute = '', array $params = []): string
    {
        if (!$callbackRoute) {
