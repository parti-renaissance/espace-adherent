        ...
        $sql = <<<'SQL'
            SELECT
            	(
            		...
            		FROM procuration_request_slot AS request_slot
            	...
            	(
            		...
            		FROM procuration_proxy_slot AS proxy_slot
            ...
            FROM procuration_rounds AS round
            ...
            (
            	SELECT
            		...
            		(
            			...
            			FROM procuration_request_slot AS request_slot
            			INNER JOIN procuration_requests AS request
            		...
            		(
            			...
            			FROM procuration_proxy_slot AS proxy_slot
            			INNER JOIN procuration_proxies AS proxy
            		...
            		(
            			...
            			INNER JOIN geo_zone_parent AS proxy_gzp
            				ON proxy_gzp.child_id = proxy_zone.id
            			LEFT JOIN procuration_request_slot AS matched_request_slot
            	...
            	INNER JOIN procuration_rounds AS round
