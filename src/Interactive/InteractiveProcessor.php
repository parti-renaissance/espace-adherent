...
final class InteractiveProcessor
{
    ...
    /**
     * @var InteractiveChoice|null
     *
     * @Assert\NotBlank(groups={"fill_info"})
     * @Assert\Type("AppBundle\Entity\InteractiveChoice", groups={"fill_info"})
     */
     ...
     * @Assert\All({
     *     @Assert\Type("AppBundle\Entity\InteractiveChoice")
     * }, groups={"fill_cases"})
     */
    public $friendCases = [];
    ...
    {
        foreach (InteractiveChoice::getStepsOrderForEmail() as $step) {
            switch ($step) {
                case InteractiveChoice::STEP_FRIEND_PROFESSIONAL_POSITION:
                    $choices = [$this->friendPosition];

                    break;
                case InteractiveChoice::STEP_FRIEND_CASES:
                    $choices = $this->friendCases;

                    break;
                case InteractiveChoice::STEP_FRIEND_APPRECIATIONS:
