...
class AssessorRequestCommand implements RecaptchaChallengeInterface
{
    ...
    #[Assert\Choice(callback: ['App\ValueObject\Genders', 'all'], message: 'common.gender.invalid_choice', groups: ['fill_personal_info'])]
    private $gender;
    ...
    #[Assert\Choice(callback: ['App\Entity\AssessorOfficeEnum', 'toArray'], message: 'assessor.office.invalid_choice', groups: ['fill_assessor_info'])]
    ...
    #[Assert\Choice(callback: ['App\Assessor\AssessorRequestElectionRoundsEnum', 'toArray'], message: 'assessor.election_rounds.invalid_choice', multiple: true, groups: ['fill_assessor_info'])]
