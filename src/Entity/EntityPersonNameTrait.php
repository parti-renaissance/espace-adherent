...
trait EntityPersonNameTrait
{
     ...
     */
    #[SymfonySerializer\Groups(['user_profile', 'export', 'cause_read', 'profile_read', 'event_read', 'event_list_read', 'adherent_autocomplete', 'phoning_campaign_history_read_list', 'phoning_campaign_replies_list', 'pap_campaign_replies_list', 'pap_address_list', 'pap_address_read', 'message_read_list', 'pap_campaign_history_read_list', 'pap_building_statistics_read', 'survey_list_dc', 'survey_read_dc', 'survey_replies_list', 'adherent_change_diff', 'my_team_member_read', 'my_team_read_list', 'scope', 'elected_representative_read', 'committee_candidacy:read', 'committee_election:read'])]
    private $firstName = '';
