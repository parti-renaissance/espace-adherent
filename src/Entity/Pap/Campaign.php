...
#[ApiResource(
    ...
    operations: [
        ...
        new Put(
            ...
            security: "is_granted('REQUEST_SCOPE_GRANTED', 'pap') and is_granted('SCOPE_CAN_MANAGE', object)"
        ),
        new Get(
        ...
        new Delete(
            uriTemplate: '/v3/pap_campaigns/{uuid}',
            requirements: ['uuid' => '%pattern_uuid%'],
            security: "is_granted('REQUEST_SCOPE_GRANTED', 'pap') and is_granted('CAN_DELETE_PAP_CAMPAIGN', object)"
        ),
        new GetCollection(
