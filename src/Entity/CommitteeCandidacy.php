...
#[ApiResource(routePrefix: '/v3', attributes: ['normalization_context' => ['groups' => ['committee_candidacy:read']], 'denormalization_context' => ['groups' => ['committee_candidacy:write']], 'security' => "is_granted('ROLE_OAUTH_SCOPE_JEMENGAGE_ADMIN') and is_granted('IS_FEATURE_GRANTED', 'committee')", 'validation_groups' => ['api_committee_candidacy_validation']], itemOperations: ['get' => ['path' => '/committee_candidacies/{uuid}', 'requirements' => ['uuid' => '%pattern_uuid%'], 'security' => "is_granted('ROLE_OAUTH_SCOPE_JEMENGAGE_ADMIN') and is_granted('IS_FEATURE_GRANTED', 'committee') and is_granted('MANAGE_ZONEABLE_ITEM__FOR_SCOPE', object.getCommittee())"], 'delete' => ['path' => '/committee_candidacies/{uuid}', 'requirements' => ['uuid' => '%pattern_uuid%'], 'security' => "is_granted('ROLE_OAUTH_SCOPE_JEMENGAGE_ADMIN') and is_granted('IS_FEATURE_GRANTED', 'committee') and is_granted('MANAGE_ZONEABLE_ITEM__FOR_SCOPE', object.getCommittee()) and not object.isVotePeriodStarted()"]], collectionOperations: ['post' => ['path' => '/committee_candidacies']])]
