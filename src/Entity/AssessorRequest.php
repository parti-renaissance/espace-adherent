...
class AssessorRequest implements RecaptchaChallengeInterface
{
    ...
    #[Assert\Choice(callback: ['App\Entity\AssessorOfficeEnum', 'toArray'], message: 'assessor.office.invalid_choice')]
    ...
    #[Assert\Choice(callback: ['App\Assessor\AssessorRequestElectionRoundsEnum', 'toArray'], message: 'assessor.election_rounds.invalid_choice', multiple: true)]
