...
class AssessorRequest implements RecaptchaChallengeInterface
{
    ...
    #[Assert\Choice(callback: ['App\Entity\AssessorOfficeEnum', 'toArray'], message: 'assessor.office.invalid_choice', strict: true)]
    ...
    #[Assert\Choice(callback: ['App\Assessor\AssessorRequestElectionRoundsEnum', 'toArray'], message: 'assessor.election_rounds.invalid_choice', strict: true, multiple: true)]
