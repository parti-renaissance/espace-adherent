...
#[ApiResource(attributes: ['filters' => [DepartmentSiteScopeFilter::class], 'normalization_context' => ['groups' => ['department_site_read']], 'denormalization_context' => ['groups' => ['department_site_write']], 'security' => "is_granted('ROLE_OAUTH_SCOPE_JEMENGAGE_ADMIN') and is_granted('IS_FEATURE_GRANTED', 'department_site')"], itemOperations: ['get' => ['path' => '/v3/department_sites/{uuid}', 'requirements' => ['uuid' => '%pattern_uuid%']], 'put' => ['path' => '/v3/department_sites/{uuid}', 'requirements' => ['uuid' => '%pattern_uuid%'], 'normalization_context' => ['groups' => ['department_site_post_write']]]], collectionOperations: ['get' => ['path' => '/v3/department_sites', 'normalization_context' => ['groups' => ['department_site_read_list']]], 'post' => ['path' => '/v3/department_sites', 'normalization_context' => ['groups' => ['department_site_post_write']]]])]
