...
#[ApiResource(
    operations: [
        ...
        new HttpOperation(
            ...
            security: "is_granted('CAN_SUBSCRIBE_EVENT', object)",
            deserialize: false
        ),
        new HttpOperation(
            method: 'POST',
...
class Event implements \Stringable, ReportableInterface, GeoPointInterface, AddressHolderInterface, ZoneableEntityInterface, AuthorInstanceInterface, ImageExposeInterface, ImageFullManageableInterface, IndexableEntityInterface, NotificationObjectInterface, AlertOwnerInterface, HitTargetInterface
{
    ...
    #[Assert\Expression("this.visibility !== enum('App\\\Event\\\EventVisibilityEnum::INVITATION') or this.agora !== null or this.getCommittee() !== null", message: 'L\'Agora ou le Comité doit être renseigné pour un événement sur invitation', groups: ['event_creation'])]
    #[Groups(['event_read', 'event_write', 'event_write_limited', 'event_list_read'])]
    ...
    {
        return EventVisibilityEnum::INVITATION === $this->visibility;
    }
