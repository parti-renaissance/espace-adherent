...
#[ORM\Entity]
#[ApiResource(attributes: ['routePrefix' => '/v3/procuration', 'security' => "is_granted('ROLE_OAUTH_SCOPE_JEMENGAGE_ADMIN') and is_granted('IS_FEATURE_GRANTED', 'procurations')", 'normalization_context' => ['groups' => ['procuration_proxy_slot_read']]], itemOperations: ['put' => ['path' => '/proxy_slots/{uuid}', 'requirements' => ['uuid' => '%pattern_uuid%'], 'denormalization_context' => ['groups' => ['procuration_proxy_slot_write']]]], collectionOperations: [])]
