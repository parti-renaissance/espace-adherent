...
class ProcurationRequest implements RecaptchaChallengeInterface
{
    ...
    #[Assert\Choice(callback: ['App\ValueObject\Genders', 'all'], message: 'common.gender.invalid_choice', strict: true, groups: ['profile'])]
    private $gender;
    ...
    #[Assert\Expression('(this.getVoteCountry() == constant(\'App\\\Address\\\Address::FRANCE\') and value != null) or (this.getVoteCountry() != constant(\'App\\\Address\\\Address', message: 'procuration.postal_code.not_empty', groups: ['vote'])]
