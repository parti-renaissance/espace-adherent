...
class ProcurationProxy implements RecaptchaChallengeInterface
{
    ...
    #[Assert\Choice(callback: ['App\ValueObject\Genders', 'all'], message: 'common.gender.invalid_choice', strict: true, groups: ['front'])]
    private $gender;
     ...
     */
    #[Assert\Length(max: 15, groups: ['front'])]
    #[Assert\Expression('(this.getVoteCountry() == constant(\'App\\\Address\\\Address::FRANCE\') and value != null) or (this.getVoteCountry() != constant(\'App\\\Address\\\Address', message: 'procuration.postal_code.not_empty', groups: ['front'])]
    ...
    #[Assert\Expression('(this.getVoteCountry() == constant(\'App\\\Address\\\Address::FRANCE\') and value <= 2) or (this.getVoteCountry() != constant(\'App\\\Address\\\Address', message: 'procuration.vote_country.conditions', groups: ['front', 'Default'])]
