...
class CampaignHistory implements DataSurveyAwareInterface
{
     ...
     */
    #[Assert\Choice(callback: ['App\Phoning\CampaignHistoryTypeEnum', 'toArray'], message: 'phoning.campaign_history.type.invalid_choice', strict: true)]
     ...
     */
    #[Assert\NotNull]
    #[Assert\Choice(choices: App\Phoning\CampaignHistoryStatusEnum::AFTER_CALL_STATUS, message: 'phoning.campaign_history.status.invalid_choice', strict: true)]
     ...
     */
    #[Assert\Choice(callback: ['App\Phoning\CampaignHistoryEngagementEnum', 'toArray'], message: 'phoning.campaign_history.engagement.invalid_choice', strict: true)]
    #[Groups(['phoning_campaign_history_write', 'phoning_campaign_history_read_list'])]
    private $engagement;
