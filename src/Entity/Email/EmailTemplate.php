...
#[ApiResource(
    operations: [
        new Get(
            ...
            security: "is_granted('REQUEST_SCOPE_GRANTED', 'messages') and is_granted('CAN_READ_EMAIL_TEMPLATE', object)"
        ),
        new Put(
            uriTemplate: '/email_templates/{uuid}',
            requirements: ['uuid' => '%pattern_uuid%'],
            normalizationContext: ['groups' => ['email_template_read_restricted']],
            security: "is_granted('REQUEST_SCOPE_GRANTED', 'messages') and object.getCreatedByAdherent() and (object.getCreatedByAdherent() == user or user.hasDelegatedFromUser(object.getCreatedByAdherent(), 'messages'))"
        ),
        new Delete(
            uriTemplate: '/email_templates/{uuid}',
            requirements: ['uuid' => '%pattern_uuid%'],
