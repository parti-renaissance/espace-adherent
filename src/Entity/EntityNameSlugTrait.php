...
trait EntityNameSlugTrait
{
    ...
    #[Groups(['adherent_committees_modal', 'jecoute_region_read', 'cause_read', 'cause_write', 'event_read', 'committee:list', 'committee:write', 'committee:write_limited', 'national_event_inscription:webhook', 'user_profile', 'profile_read'])]
    #[ORM\Column]
    protected $name;
