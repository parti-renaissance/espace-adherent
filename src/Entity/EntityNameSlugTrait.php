...
trait EntityNameSlugTrait
{
     ...
     * @ORM\Column
     */
    #[Groups(['adherent_committees_modal', 'jecoute_region_read', 'cause_read', 'cause_write', 'event_read', 'committee_sync', 'committee:list', 'committee:write'])]
     ...
     */
    #[Groups(['adherent_committees_modal', 'jecoute_region_read', 'cause_read', 'event_list_read', 'event_read', 'committee_sync'])]
    protected $slug;
