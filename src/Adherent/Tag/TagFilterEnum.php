...
class TagFilterEnum extends Enum
{
    ...
    {
        return [
            self::UNDECLARED_REVENUE => [TagEnum::ELU_DECLARATION_OK => false],
            self::COTISATION_OK => [TagEnum::ELU_COTISATION_OK => true],
            self::COTISATION_EXEMPT => [TagEnum::ELU_COTISATION_OK => true, TagEnum::ELU_EXEMPTE => true],
            self::COTISATION_ELIGIBLE => [TagEnum::ELU_COTISATION_OK => true, TagEnum::ELU_COTISATION_ELIGIBLE => true],
            self::COTISATION_NOT_ELIGIBLE => [TagEnum::ELU_COTISATION_OK => true, TagEnum::ELU_COTISATION_ELIGIBLE => false],
