 ...
 *     public_key?: scalar|null, // Default: null
 *     parameters: array{
 *         production?: scalar|null, // Default: false
 *         currencies?: list<scalar|null>,
 *         site: scalar|null,
 *         rank?: scalar|null, // Default: null
 *         rang?: scalar|null, // Default: null
 *         login?: scalar|null, // Default: null
 *         cle?: scalar|null, // Default: null
 *         hmac: array{
 *             algorithm?: scalar|null, // Default: "sha512"
 *             key: scalar|null,
 *             signature_name?: scalar|null, // Default: "Sign"
 *         },
 *     },
 *     servers?: array{
 *         system?: array{
 *             primary?: array{
 *                 protocol?: scalar|null, // Default: "https"
 *                 host?: scalar|null, // Default: "tpeweb.paybox.com"
 *                 system_path?: scalar|null, // Default: "/cgi/MYchoix_pagepaiement.cgi"
 *                 cancellation_path?: scalar|null, // Default: "/cgi-bin/ResAbon.cgi"
 *                 test_path?: scalar|null, // Default: "/load.html"
 *             },
 *             secondary?: array{
 *                 protocol?: scalar|null, // Default: "https"
 *                 host?: scalar|null, // Default: "tpeweb1.paybox.com"
 *                 system_path?: scalar|null, // Default: "/cgi/MYchoix_pagepaiement.cgi"
 *                 cancellation_path?: scalar|null, // Default: "/cgi-bin/ResAbon.cgi"
 *                 test_path?: scalar|null, // Default: "/load.html"
 *             },
 *             preprod?: array{
 *                 protocol?: scalar|null, // Default: "https"
 *                 host?: scalar|null, // Default: "preprod-tpeweb.paybox.com"
 *                 system_path?: scalar|null, // Default: "/cgi/MYchoix_pagepaiement.cgi"
 *                 cancellation_path?: scalar|null, // Default: "/cgi-bin/ResAbon.cgi"
 *                 test_path?: scalar|null, // Default: "/load.html"
 *             },
 ...
 *             primary?: array{
 *                 protocol?: scalar|null, // Default: "https"
 *                 host?: scalar|null, // Default: "ppps.paybox.com"
 *                 api_path?: scalar|null, // Default: "/PPPS.php"
 *             },
 *             secondary?: array{
 *                 protocol?: scalar|null, // Default: "https"
 *                 host?: scalar|null, // Default: "ppps1.paybox.com"
 *                 api_path?: scalar|null, // Default: "/PPPS.php"
 *             },
 *             preprod?: array{
 *                 protocol?: scalar|null, // Default: "https"
 *                 host?: scalar|null, // Default: "preprod-ppps.paybox.com"
 *                 api_path?: scalar|null, // Default: "/PPPS.php"
 *             },
 *         },
 *     },
 *     transport?: scalar|null, // Default: "Lexik\\Bundle\\PayboxBundle\\Transport\\CurlTransport"
 * }
 ...
 *         cache_lifetime?: scalar|null, // Default: null
 *         cache_precision?: scalar|null, // Precision of the coordinates to cache. // Default: null
 *         limit?: scalar|null, // Default: null
 *         locale?: scalar|null, // Default: null
 *         logger?: scalar|null, // Default: null
 ...
 *         enabled?: bool, // Default: false
 *         local_ip?: scalar|null, // Default: "127.0.0.1"
 *         ip?: scalar|null, // Default: null
 *         use_faker?: bool, // Default: false
 *     },
 * }
 * @psalm-type CocurSlugifyConfig = array{
 *     lowercase?: bool,
 *     lowercase_after_regexp?: bool,
 *     trim?: bool,
 *     strip_tags?: bool,
 *     separator?: scalar|null,
 *     regexp?: scalar|null,
 *     rulesets?: list<scalar|null>,
 * }
 * @psalm-type EndroidQrCodeConfig = array<string, mixed>
 * @psalm-type A2lixAutoFormConfig = array{
 *     excluded_fields?: list<scalar|null>,
 * }
 * @psalm-type A2lixTranslationFormConfig = array{
 *     locale_provider?: scalar|null, // Set your own LocaleProvider service identifier if required // Default: "default"
 *     default_locale?: scalar|null, // Set your own default locale if different from the SymfonyFramework locale. eg: en // Default: null
 *     locales?: list<scalar|null>,
 *     required_locales?: list<scalar|null>,
 *     templating?: scalar|null, // Set your own template path if required // Default: "@A2lixTranslationForm/bootstrap_4_layout.html.twig"
 * }
 ...
 *     nbResults?: scalar|null, // Default: 20
 *     settingsDirectory?: scalar|null, // Default: null
 *     batchSize?: scalar|null, // Default: 500
 *     doctrineSubscribedEvents?: list<scalar|null>,
 *     serializer?: scalar|null, // Default: "serializer"
 *     indices?: array<string, array{ // Default: []
 *         class: scalar|null,
 *         enable_serializer_groups?: bool, // When set to true, it will call normalize method with an extra groups parameter "groups" => [Searchable::NORMALIZATION_GROUP] // Default: false
 *         index_if?: scalar|null, // Property accessor path (like method or property name) used to decide if an entry should be indexed. // Default: null
 *     }>,
 * }
 ...
 *         project_id?: scalar|null, // Override the project id. Useful when credentials and service are from different projects // Default: null
 *         public?: scalar|null, // If set to false, the service and its alias can only be used via dependency injection, and not be retrieved from the container directly. // Default: true
 *         default?: scalar|null, // If set to true, this project will be used when type hinting the component classes of the Firebase SDK, e.g. Kreait\Firebase\Auth, Kreait\Firebase\Database, Kreait\Firebase\Messaging, etc. // Default: null
 *         database_uri?: scalar|null, // Should only be used if the URL of your Realtime Database can not be generated with the project id of the given Service Account
 *         tenant_id?: scalar|null, // Make the client tenant aware // Default: null
 *         default_dynamic_links_domain?: scalar|null, // The default domain for dynamic links
 *         verifier_cache?: scalar|null, // Used to cache Google's public keys. // Default: null
 *         auth_token_cache?: scalar|null, // Used to cache the authentication tokens for connecting to the Firebase servers. // Default: null
 *         http_request_logger?: scalar|null, // If set, logs simple HTTP request and response statuses // Default: null
 ...
 *     position_handler?: scalar|null, // Default: "runroom.sortable_behavior.service.gedmo_position"
 *     position_field?: array{
 *         default?: scalar|null, // Default: "position"
 *         entities?: list<scalar|null>,
 *     },
 ...
 *         attributes?: array<string, array<string, scalar|null>>,
 *         elements?: array<string, list<mixed>>,
 *         blank_elements?: list<scalar|null>,
 *         parents?: list<scalar|null>,
 *     }>,
 * }
