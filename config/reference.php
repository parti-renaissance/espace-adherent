 ...
 *     public_key?: scalar|null|Param, // Default: null
 *     parameters: array{
 *         production?: scalar|null|Param, // Default: false
 *         currencies?: list<scalar|null|Param>,
 *         site: scalar|null|Param,
 *         rank?: scalar|null|Param, // Default: null
 *         rang?: scalar|null|Param, // Default: null
 *         login?: scalar|null|Param, // Default: null
 *         cle?: scalar|null|Param, // Default: null
 *         hmac: array{
 *             algorithm?: scalar|null|Param, // Default: "sha512"
 *             key: scalar|null|Param,
 *             signature_name?: scalar|null|Param, // Default: "Sign"
 *         },
 *     },
 *     servers?: array{
 *         system?: array{
 *             primary?: array{
 *                 protocol?: scalar|null|Param, // Default: "https"
 *                 host?: scalar|null|Param, // Default: "tpeweb.paybox.com"
 *                 system_path?: scalar|null|Param, // Default: "/cgi/MYchoix_pagepaiement.cgi"
 *                 cancellation_path?: scalar|null|Param, // Default: "/cgi-bin/ResAbon.cgi"
 *                 test_path?: scalar|null|Param, // Default: "/load.html"
 *             },
 *             secondary?: array{
 *                 protocol?: scalar|null|Param, // Default: "https"
 *                 host?: scalar|null|Param, // Default: "tpeweb1.paybox.com"
 *                 system_path?: scalar|null|Param, // Default: "/cgi/MYchoix_pagepaiement.cgi"
 *                 cancellation_path?: scalar|null|Param, // Default: "/cgi-bin/ResAbon.cgi"
 *                 test_path?: scalar|null|Param, // Default: "/load.html"
 *             },
 *             preprod?: array{
 *                 protocol?: scalar|null|Param, // Default: "https"
 *                 host?: scalar|null|Param, // Default: "preprod-tpeweb.paybox.com"
 *                 system_path?: scalar|null|Param, // Default: "/cgi/MYchoix_pagepaiement.cgi"
 *                 cancellation_path?: scalar|null|Param, // Default: "/cgi-bin/ResAbon.cgi"
 *                 test_path?: scalar|null|Param, // Default: "/load.html"
 *             },
 ...
 *             primary?: array{
 *                 protocol?: scalar|null|Param, // Default: "https"
 *                 host?: scalar|null|Param, // Default: "ppps.paybox.com"
 *                 api_path?: scalar|null|Param, // Default: "/PPPS.php"
 *             },
 *             secondary?: array{
 *                 protocol?: scalar|null|Param, // Default: "https"
 *                 host?: scalar|null|Param, // Default: "ppps1.paybox.com"
 *                 api_path?: scalar|null|Param, // Default: "/PPPS.php"
 *             },
 *             preprod?: array{
 *                 protocol?: scalar|null|Param, // Default: "https"
 *                 host?: scalar|null|Param, // Default: "preprod-ppps.paybox.com"
 *                 api_path?: scalar|null|Param, // Default: "/PPPS.php"
 *             },
 *         },
 *     },
 *     transport?: scalar|null|Param, // Default: "Lexik\\Bundle\\PayboxBundle\\Transport\\CurlTransport"
 * }
 ...
 *         cache_lifetime?: scalar|null|Param, // Default: null
 *         cache_precision?: scalar|null|Param, // Precision of the coordinates to cache. // Default: null
 *         limit?: scalar|null|Param, // Default: null
 *         locale?: scalar|null|Param, // Default: null
 *         logger?: scalar|null|Param, // Default: null
 *         aliases?: list<scalar|null|Param>,
 *         plugins?: list<array{ // Default: []
 *             reference?: bool|array{ // Reference to a plugin service
 *                 enabled?: bool|Param, // Default: false
 *                 id: scalar|null|Param, // Service id of a plugin
 *             },
 *         }>,
 *     }>,
 ...
 *         enabled?: bool|Param, // Default: false
 *         local_ip?: scalar|null|Param, // Default: "127.0.0.1"
 *         ip?: scalar|null|Param, // Default: null
 ...
 *     separator?: scalar|null|Param,
 *     regexp?: scalar|null|Param,
 *     rulesets?: list<scalar|null|Param>,
 * }
 * @psalm-type EndroidQrCodeConfig = array<string, mixed>
 * @psalm-type A2lixAutoFormConfig = array{
 *     excluded_fields?: list<scalar|null|Param>,
 * }
 * @psalm-type A2lixTranslationFormConfig = array{
 *     locale_provider?: scalar|null|Param, // Set your own LocaleProvider service identifier if required // Default: "default"
 *     default_locale?: scalar|null|Param, // Set your own default locale if different from the SymfonyFramework locale. eg: en // Default: null
 *     locales?: list<scalar|null|Param>,
 *     required_locales?: list<scalar|null|Param>,
 *     templating?: scalar|null|Param, // Set your own template path if required // Default: "@A2lixTranslationForm/bootstrap_4_layout.html.twig"
 * }
 * @psalm-type SonataExporterConfig = array{
 *     exporter?: array{
 *         default_writers?: list<scalar|null|Param>,
 *     },
 *     writers?: array{
 *         csv?: array{
 *             filename?: scalar|null|Param, // path to the output file // Default: "php://output"
 *             delimiter?: scalar|null|Param, // delimits csv values // Default: ","
 *             enclosure?: scalar|null|Param, // will be used when a value contains the delimiter // Default: "\""
 *             escape?: scalar|null|Param, // will be used when a value contains the enclosure // Default: "\\"
 ...
 *             filename?: scalar|null|Param, // path to the output file // Default: "php://output"
 *             show_headers?: bool|Param, // add column names as the first line // Default: true
 *             main_element?: scalar|null|Param, // name of the wrapping element // Default: "datas"
 *             child_element?: scalar|null|Param, // name of elements corresponding to rows // Default: "data"
 *         },
 *     },
 * }
 ...
 *     nbResults?: scalar|null|Param, // Default: 20
 *     settingsDirectory?: scalar|null|Param, // Default: null
 *     batchSize?: scalar|null|Param, // Default: 500
 *     doctrineSubscribedEvents?: list<scalar|null|Param>,
 ...
 *         index_if?: scalar|null|Param, // Property accessor path (like method or property name) used to decide if an entry should be indexed. // Default: null
 *     }>,
 * }
 ...
 *         project_id?: scalar|null|Param, // Override the project id. Useful when credentials and service are from different projects // Default: null
 *         public?: scalar|null|Param, // If set to false, the service and its alias can only be used via dependency injection, and not be retrieved from the container directly. // Default: true
 *         default?: scalar|null|Param, // If set to true, this project will be used when type hinting the component classes of the Firebase SDK, e.g. Kreait\Firebase\Auth, Kreait\Firebase\Database, Kreait\Firebase\Messaging, etc. // Default: null
 *         database_uri?: scalar|null|Param, // Should only be used if the URL of your Realtime Database can not be generated with the project id of the given Service Account
 *         tenant_id?: scalar|null|Param, // Make the client tenant aware // Default: null
 *         default_dynamic_links_domain?: scalar|null|Param, // The default domain for dynamic links
 *         verifier_cache?: scalar|null|Param, // Used to cache Google's public keys. // Default: null
 *         auth_token_cache?: scalar|null|Param, // Used to cache the authentication tokens for connecting to the Firebase servers. // Default: null
 *         http_request_logger?: scalar|null|Param, // If set, logs simple HTTP request and response statuses // Default: null
 *         http_request_debug_logger?: scalar|null|Param, // If set, logs detailed HTTP request and response statuses // Default: null
 *     }>,
 * }
 ...
 *     position_handler?: scalar|null|Param, // Default: "runroom.sortable_behavior.service.gedmo_position"
 *     position_field?: array{
 *         default?: scalar|null|Param, // Default: "position"
 *         entities?: list<scalar|null|Param>,
 *     },
 ...
 *     default_cache_serializer_path?: scalar|null|Param, // Default: "%kernel.cache_dir%/htmlpurifier"
 *     default_cache_serializer_permissions?: scalar|null|Param, // Default: 493
 *     html_profiles?: array<string, array{ // Default: []
 *         config?: array<string, mixed>,
 *         attributes?: array<string, array<string, scalar|null|Param>>,
 *         elements?: array<string, list<mixed>>,
 *         blank_elements?: list<scalar|null|Param>,
 *         parents?: list<scalar|null|Param>,
 *     }>,
 * }
