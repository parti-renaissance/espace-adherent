    ...
    $containerConfigurator->extension('security', [
        ...
        'role_hierarchy' => [
            ...
            'ROLE_ADMIN_TERRITOIRES_NATIONAL_EVENTS' => [
                ...
                'ROLE_APP_ADMIN_NATIONAL_EVENT_INSCRIPTIONS_LIST',
                'ROLE_APP_ADMIN_NATIONAL_EVENT_INSCRIPTIONS_VIEW',
                'ROLE_APP_ADMIN_NATIONAL_EVENT_INSCRIPTIONS_EDIT',
                'ROLE_APP_ADMIN_NATIONAL_EVENT_INSCRIPTIONS_DELETE',
                'ROLE_APP_ADMIN_NATIONAL_EVENT_INSCRIPTIONS_EXPORT',
            ],
            ...
            'ROLE_ADMIN_TERRITOIRES_NATIONAL_EVENTS_INSCRIPTIONS_CREATE' => [
                ...
                'ROLE_APP_ADMIN_NATIONAL_EVENT_INSCRIPTIONS_VIEW',
                'ROLE_APP_ADMIN_NATIONAL_EVENT_INSCRIPTIONS_EDIT',
                'ROLE_APP_ADMIN_NATIONAL_EVENT_INSCRIPTIONS_CREATE',
                'ROLE_APP_ADMIN_NATIONAL_EVENT_JEM_INSCRIPTIONS_CREATE',
            ],
            'ROLE_ADMIN_TERRITOIRES_NATIONAL_EVENTS_JEM' => [
                'ROLE_APP_ADMIN_NATIONAL_EVENT_JEM_ALL',
                'ROLE_APP_ADMIN_NATIONAL_EVENT_JEM_INSCRIPTIONS_LIST',
                'ROLE_APP_ADMIN_NATIONAL_EVENT_JEM_INSCRIPTIONS_VIEW',
                'ROLE_APP_ADMIN_NATIONAL_EVENT_JEM_INSCRIPTIONS_EDIT',
                'ROLE_APP_ADMIN_NATIONAL_EVENT_JEM_INSCRIPTIONS_DELETE',
                'ROLE_APP_ADMIN_NATIONAL_EVENT_JEM_INSCRIPTIONS_EXPORT',
            ...
            'ROLE_ADMIN_TERRITOIRES_PROCURATION_ELECTIONS' => [
                'ROLE_APP_ADMIN_PROCURATION_ELECTION_ALL',
            ],
            'ROLE_ADMIN_TERRITOIRES_PROCURATION_MANAGERS' => [
                'ROLE_APP_ADMIN_PROCURATION_REQUEST_ALL',
                'ROLE_APP_ADMIN_PROCURATION_PROXY_ALL',
                'ROLE_APP_ADMIN_PROCURATION_PROCURATION_REQUEST_ALL',
            ],
