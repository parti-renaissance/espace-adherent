...
class MailerServiceTest extends TestCase
{
    public function testSendMessage()
    {
        ...
        $service = new MailerService($dispatcher, new NullTransport(), new EmailTemplateFactory('contact@en-marche.fr', 'En Marche', 'AppBundle\Mailjet\EmailTemplate'));
    ...
    public function testCannotSendMessage()
    {
        ...
        $service = new MailerService($dispatcher, new FailingTransport(), new EmailTemplateFactory('contact@en-marche.fr', 'En Marche', 'AppBundle\Mailjet\EmailTemplate'));
