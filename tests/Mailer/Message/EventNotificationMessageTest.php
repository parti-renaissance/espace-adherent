...
{
    private const SHOW_EVENT_URL = 'https://enmarche.code/comites/59b1314d-dcfb-4a4c-83e1-212841d0bd0f/evenements/2017-01-31-en-marche-lyon';

    public function testCreateEventNotificationMessage(): void
    {
        ...
        $this->assertSame(
            [
                ...
                'event_hour' => '15h30',
                'event_address' => '15 allées Paul Bocuse, 69006 Lyon 6ème',
    ...
    public function testCreateEventNotificationMessageTimeZone(): void
    {
        ...
        $this->assertSame(
            [
                ...
                'event_hour' => '08h00',
                'event_address' => 'conrad hong-kong pacific place 88, 69006 Lyon 6ème',
                'event_slug' => self::SHOW_EVENT_URL,
                'event_description' => '',
                'committee_name' => 'EM Lyon',
                'visio_url' => null,
