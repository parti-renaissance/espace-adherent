...
class EmailPersisterEventSubscriberTest extends TestCase
{
    ...
    public function testOnMailerDeliveryMessage()
    {
        ...
        $this->subscriber->onMailerDeliveryMessage(new MailerEvent(
            ...
            EmailTemplate::createWithMessage($message, 'noreply@en-marche.fr')
        ));
    }
...
EOF;
        ...
        $message = DummyMessage::create();
        $email = EmailTemplate::createWithMessage($message, 'noreply@en-marche.fr');
...
EOF;
    ...
    protected function setUp()
    {
        ...
        $this->repository->expects($this->any())->method('getClassName')->willReturn(MailjetEmail::class);
