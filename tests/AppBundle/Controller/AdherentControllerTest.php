...
class AdherentControllerTest extends WebTestCase
{
    ...
    public function testEditAdherentProfile()
    {
        ...
        $this->assertSame("Cette valeur n'est pas un identifiant valide de ville française.", $errors->eq(4)->text(), 'City should be erroneous.');
        $this->assertSame("L'adresse est obligatoire.", $errors->eq(5)->text(), 'Address should be erroneous.');
        $this->assertSame("Cette valeur n'est pas valide.", $errors->eq(6)->text(), 'Birth date should be erroneous.');
