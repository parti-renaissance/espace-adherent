...
class CausesControllerTest extends AbstractEnMarcheWebTestCase
{
    ...
    public function testSeeCausesPageAsCoalitionModerator(): void
    {
        ...
        $this->assertStringContainsString('(Paris 8ème)', $causeFields->eq(3)->text());
    ...
    public function testExportCausesCsv(): void
    {
        ...
        $this->assertStringContainsString('8,Approuvée,Justice,75008,"Paris 8ème",0,"Cause pour la justice","Lorem ipsum dolor sit amet, consectetur adipiscing elit.",Oui,Jacques,Picard,,http://coalitions.code/cause/44249b1d-ea10-41e0-b288-5eb74fa886ba,', $responseContent);
        $this->assertStringContainsString('7,Approuvée,Éducation,75008,"Paris 8ème",0,"Cause pour l\'éducation","Lorem ipsum dolor sit amet, consectetur adipiscing elit.",Oui,Jacques,Picard,http://enmarche.code/assets/images/causes/532c52e162feb2f6cfae99d5ed52d41f.png,http://coalitions.code/cause/fa6bd29c-48b7-490e-90fb-48ab5fb2ddf8', $responseContent);
        $this->assertStringContainsString('6,Approuvée,Culture,77190,Dammarie-les-Lys,0,"Cause pour la culture 3","Description de la cause pour la culture 3",Oui,Carl,Mirabeau,,http://coalitions.code/cause/5f8a6d40-9e69-4311-a45b-67c00d30ad41', $responseContent);
        $this->assertStringContainsString('5,Approuvée,Culture,77190,Dammarie-les-Lys,0,"Cause pour la culture 2","Description de la cause pour la culture 2",Oui,Carl,Mirabeau,http://enmarche.code/assets/images/causes/73a6283e0b639cbeb50b9b28d401eaca.png,http://coalitions.code/cause/017491f9-1953-482e-b491-20418235af1f,', $responseContent);
        $this->assertStringContainsString('4,Approuvée,Culture,77190,Dammarie-les-Lys,5,"Cause pour la culture","Lorem ipsum dolor sit amet, consectetur adipiscing elit.",Oui,Carl,Mirabeau,http://enmarche.code/assets/images/causes/644d1c64512ab5489ab8590a3b313517.png,http://coalitions.code/cause/55056e7c-2b5f-4ef6-880e-cde0511f79b2', $responseContent);
        $this->assertStringContainsString('3,Refusée,Culture,75008,"Paris 8ème",0,"Cause refusée","Pellentesque aliquam neque nec volutpat ultricies.",Oui,Jacques,Picard,,http://coalitions.code/cause/227a2360-f4b3-4e3f-8f85-5b1700300ca9', $responseContent);
        $this->assertStringContainsString('2,"En attente",Justice,75008,"Paris 8ème",0,"Cause en attente","Lorem ipsum dolor sit amet, consectetur adipiscing elit.",Oui,Jacques,Picard,,http://coalitions.code/cause/253b0ed7-7426-15f8-97f9-2bb32d0a4d17,', $responseContent);
