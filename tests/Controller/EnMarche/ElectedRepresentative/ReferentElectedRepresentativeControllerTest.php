...
#[Group('functional')]
class ReferentElectedRepresentativeControllerTest extends AbstractEnMarcheWebTestCase
{
    ...
    public function testListElectedRepresentatives()
    {
        ...
        $this->assertCount(6, $crawler->filter('tbody tr.referent__item'));
        ...
        $this->assertStringContainsString('DUFOUR Michelle', $crawler->filter('tbody tr.referent__item')->eq(3)->text());
        $this->assertStringContainsString('Oui', $crawler->filter('tbody tr.referent__item')->eq(3)->text());
        $this->assertStringContainsString('LOBELL', $crawler->filter('tbody tr.referent__item')->eq(4)->text());
    }
