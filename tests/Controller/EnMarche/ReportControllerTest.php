...
class ReportControllerTest extends MysqlWebTestCase
{
    ...
    public function testAdherentCanReportCitizenProject(): void
    {
        ...
        $this->assertSame('http://enmarche.dev/report/citizen-project/aa364092-3999-4102-930c-f711ef971195?redirectUrl=/projets-citoyens/le-projet-citoyen-a-paris-8', $this->client->getCrawler()->getUri());
        $this->isSuccessful($this->client->getResponse());
    ...
    {
        $this->authenticateAsAdherent($this->client, 'benjyd@aol.com', 'HipHipHip');
        $this->client->request(Request::METHOD_GET, 'http://enmarche.dev/report/citizen-project/aa364092-3999-4102-930c-f711ef971195?redirectUrl=http%3A%2F%2Fje-te-hack.com');
        $this->isSuccessful($this->client->getResponse());
    ...
    {
        $this->authenticateAsAdherent($this->client, 'benjyd@aol.com', 'HipHipHip');
        $this->client->request(Request::METHOD_GET, 'http://enmarche.dev/report/citizen-project/aa364092-3999-4102-930c-f711ef971195');
        $this->isSuccessful($this->client->getResponse());
