...
class AmpControllerTest extends SqliteWebTestCase
{
    ...
    public function testArticlePublished()
    {
        ...
        $this->assertContains('<amp-img src="//'.Config::APP_HOST.'/assets/images/article.jpg', $this->client->getResponse()->getContent());
    }
    ...
    public function testProposalPublished()
    {
        ...
        $this->assertResponseStatusCode(Response::HTTP_OK, $response = $this->client->getResponse());
        $this->assertSame(1, $crawler->filter('html:contains("An exhibit of Markdown")')->count());
        $this->assertContains('<amp-img src="//'.Config::APP_HOST.'/assets/images/proposal.jpg', $this->client->getResponse()->getContent());
    }
    ...
    public function testOrderArticlePublished()
    {
        ...
        $this->assertResponseStatusCode(Response::HTTP_OK, $response = $this->client->getResponse());
        $this->assertSame(1, $crawler->filter('html:contains("An exhibit of Markdown")')->count());
        $this->assertContains('<amp-img src="//'.Config::APP_HOST.'/assets/images/order_article.jpg', $this->client->getResponse()->getContent());
    }
