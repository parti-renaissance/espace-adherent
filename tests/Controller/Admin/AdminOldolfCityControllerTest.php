 ...
 * @group admin
 */
class AdminOldolfCityControllerTest extends WebTestCase
{
    ...
    public function testUnindexedCityAfterRemoval()
    {
        ...
        $deleteUrl = sprintf('/admin/app/oldolf-city/%s/delete', $city->getId());
    ...
    public function testIndexedCityAfterUpdate()
    {
        ...
        $editUrl = sprintf('/admin/app/oldolf-city/%s/edit', $city->getId());
