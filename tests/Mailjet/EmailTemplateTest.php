...
class EmailTemplateTest extends TestCase
{
    ...
    {
        $email = new EmailTemplate(Uuid::uuid4(), 'donation_message', 'contact@en-marche.fr', 'En Marche !');
        $email->getBody();
    }
    ...
    public function testCreateEmailTemplate()
    {
        ...
        $body = [
            ...
            'FromName' => 'En Marche !',
            'MJ-TemplateID' => 'donation_message',
    ...
    {
        $email = new EmailTemplate(Uuid::uuid4(), 'donation_message', 'contact@en-marche.fr', 'En Marche !', 'reply@to.me');
        $email->addRecipient('john.smith@example.tld', 'John Smith', ['name' => 'John Smith']);
    ...
    {
        $email = EmailTemplate::createWithMessage(DummyMessage::create(), 'dummy_message', 'contact@en-marche.fr');
