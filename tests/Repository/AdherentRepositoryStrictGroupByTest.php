...
/**
 * Smoke tests for AdherentRepository queries that mix non-aggregated SELECT columns
 * with GROUP BY. MySQL strict mode (ONLY_FULL_GROUP_BY) rejects these unless the
 * non-grouped columns are functionally dependent on the grouped PK.
 *
