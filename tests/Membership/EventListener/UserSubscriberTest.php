...
class UserSubscriberTest extends KernelTestCase
{
    public function testSerialiseUser()
    {
        ...
        $this->assertSame(
            '{"uuid":"a046adbe-9c7b-56a9-a676-6151a6785dda","subscriptionExternalIds":[],"country":"FR","zipCode":"75008","emailAddress":"jacques.picard@en-marche.fr","firstName":"Jacques","lastName":"Picard"}',
