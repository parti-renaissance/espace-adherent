...
class Version20170419181904 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE legislative_district_zones (id SMALLINT UNSIGNED AUTO_INCREMENT NOT NULL, area_type VARCHAR(20) NOT NULL, name VARCHAR(100) NOT NULL, keywords LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE legislative_candidates ADD district_zone_id SMALLINT UNSIGNED DEFAULT NULL, ADD media_id BIGINT DEFAULT NULL, ADD slug VARCHAR(100) NOT NULL, ADD twitter_page_url VARCHAR(255) DEFAULT NULL, ADD donation_page_url VARCHAR(255) DEFAULT NULL, ADD website_url VARCHAR(255) DEFAULT NULL, ADD district_name VARCHAR(100) NOT NULL, ADD district_number VARCHAR(10) NOT NULL, ADD latitude FLOAT (10,6) DEFAULT NULL COMMENT \'(DC2Type:geo_point)\', ADD longitude FLOAT (10,6) DEFAULT NULL COMMENT \'(DC2Type:geo_point)\', ADD description LONGTEXT DEFAULT NULL, ADD first_name VARCHAR(50) NOT NULL, ADD last_name VARCHAR(50) NOT NULL, ADD display_media TINYINT(1) NOT NULL, DROP candidate_id, CHANGE id id SMALLINT UNSIGNED AUTO_INCREMENT NOT NULL, CHANGE area facebook_page_url VARCHAR(255) DEFAULT NULL');
