...
class Version20170406113002 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE ton_macron_choices (id INT UNSIGNED AUTO_INCREMENT NOT NULL, step SMALLINT UNSIGNED NOT NULL, `key` VARCHAR(10) NOT NULL, label VARCHAR(100) NOT NULL, content LONGTEXT NOT NULL, uuid CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', UNIQUE INDEX ton_macron_choices_uuid_unique (uuid), UNIQUE INDEX ton_macron_choices_key_unique (`key`), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
