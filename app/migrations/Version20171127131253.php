...
class Version20171127131253 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE citizen_projects ADD category_id INT UNSIGNED DEFAULT NULL, ADD committee_id INT UNSIGNED DEFAULT NULL, ADD subtitle VARCHAR(255) NOT NULL, ADD problem_description LONGTEXT DEFAULT NULL, ADD proposed_solution LONGTEXT DEFAULT NULL, ADD required_means LONGTEXT DEFAULT NULL, ADD assistance_needed TINYINT(1) DEFAULT \'0\' NOT NULL, DROP description');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE citizen_projects ADD description LONGTEXT NOT NULL COLLATE utf8_unicode_ci, DROP category_id, DROP committee_id, DROP subtitle, DROP problem_description, DROP proposed_solution, DROP required_means, DROP assistance_needed');
    }
}
