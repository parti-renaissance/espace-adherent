...
class Version20171011100525 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE roles (id INT UNSIGNED AUTO_INCREMENT NOT NULL, code VARCHAR(20) NOT NULL, male_name VARCHAR(100) NOT NULL, female_name VARCHAR(100) NOT NULL, UNIQUE INDEX UNIQ_B63E2EC7866F9300 (male_name), UNIQUE INDEX UNIQ_B63E2EC7844EA50D (female_name), UNIQUE INDEX board_member_role_code_unique (code), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
    ...
    {
        foreach (LoadBoardMemberRoleData::BOARD_MEMBER_ROLES as $code => $names) {
            $this->connection->insert('roles', ['code' => $code, 'male_name' => $names['male'], 'female_name' => $names['female']]);
        }
    }
