...
class Version20170731094934 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE events ADD type VARCHAR(255) NOT NULL, ADD interests LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json_array)\', ADD expert_assistance_needed TINYINT(1) DEFAULT \'0\', ADD expert_assistance_description VARCHAR(255) DEFAULT NULL, ADD coaching_requested TINYINT(1) DEFAULT \'0\', ADD coaching_request_need VARCHAR(255) DEFAULT NULL, ADD coaching_request_proposed_solution VARCHAR(255) DEFAULT NULL, ADD coaching_request_necessary_means VARCHAR(255) DEFAULT NULL, CHANGE is_for_legislatives is_for_legislatives TINYINT(1) DEFAULT \'0\'');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE events DROP type, DROP interests, DROP expert_assistance_needed, DROP expert_assistance_description, DROP coaching_requested, DROP coaching_request_need, DROP coaching_request_proposed_solution, DROP coaching_request_necessary_means, CHANGE is_for_legislatives is_for_legislatives TINYINT(1) DEFAULT \'0\' NOT NULL');
    }
}
