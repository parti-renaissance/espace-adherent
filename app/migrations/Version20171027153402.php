...
class Version20171027153402 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE group_memberships (id INT UNSIGNED AUTO_INCREMENT NOT NULL, adherent_id INT UNSIGNED DEFAULT NULL, group_uuid CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', privilege VARCHAR(10) NOT NULL, joined_at DATETIME NOT NULL, uuid CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', INDEX IDX_A3E258B725F06C53 (adherent_id), INDEX groups_memberships_role_idx (privilege), UNIQUE INDEX adherent_has_joined_group (adherent_id, group_uuid), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
