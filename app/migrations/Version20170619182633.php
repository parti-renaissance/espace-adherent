...
class Version20170619182633 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE member_summary_skills (id INT AUTO_INCREMENT NOT NULL, summary_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_CB3F6F8F2AC2D45C (summary_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('DROP TABLE member_summaries');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE member_summaries (id INT AUTO_INCREMENT NOT NULL, member_id INT UNSIGNED DEFAULT NULL, UNIQUE INDEX UNIQ_2650EA0F7597D3FE (member_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE member_summaries ADD CONSTRAINT FK_2650EA0F7597D3FE FOREIGN KEY (member_id) REFERENCES adherents (id)');
