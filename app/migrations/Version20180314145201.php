...
class Version20180314145201 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('UPDATE adherents SET emails_subscriptions = \'subscribed_emails_movement_information,subscribed_emails_government_information,subscribed_emails_weekly_letter,subscribed_emails_mooc,subscribed_emails_microlearning\' WHERE main_emails_subscription = TRUE');
