...
final class Version20181128152654 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE iw_question (id INT AUTO_INCREMENT NOT NULL, guideline_id INT DEFAULT NULL, placeholder VARCHAR(255) NOT NULL, position SMALLINT UNSIGNED NOT NULL, name VARCHAR(255) NOT NULL, mandatory TINYINT(1) NOT NULL, published TINYINT(1) NOT NULL, INDEX IDX_2AB59F30CC0B46A8 (guideline_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
