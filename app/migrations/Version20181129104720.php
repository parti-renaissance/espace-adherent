...
final class Version20181129104720 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        $this->addSql('CREATE TABLE ideas_workshop_category (id INT AUTO_INCREMENT NOT NULL, enabled TINYINT(1) NOT NULL, name VARCHAR(255) NOT NULL, canonical_name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, UNIQUE INDEX category_name_unique (name), UNIQUE INDEX category_slug_unique (slug), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE ideas_workshop_need (id INT AUTO_INCREMENT NOT NULL, enabled TINYINT(1) NOT NULL, name VARCHAR(255) NOT NULL, canonical_name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, UNIQUE INDEX need_name_unique (name), UNIQUE INDEX need_slug_unique (slug), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE ideas_workshop_comment (id INT AUTO_INCREMENT NOT NULL, thread_id INT DEFAULT NULL, adherent_id INT UNSIGNED DEFAULT NULL, text LONGTEXT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, INDEX IDX_18589988E2904019 (thread_id), INDEX IDX_1858998825F06C53 (adherent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE ideas_workshop_consultation (id INT AUTO_INCREMENT NOT NULL, response_time SMALLINT UNSIGNED NOT NULL, started_at DATE NOT NULL, ended_at DATE NOT NULL, url VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE ideas_workshop_answer (id INT AUTO_INCREMENT NOT NULL, question_id INT DEFAULT NULL, idea_id INT UNSIGNED DEFAULT NULL, text LONGTEXT NOT NULL, INDEX IDX_256A5D7B1E27F6BF (question_id), INDEX IDX_256A5D7B5B6FEF7D (idea_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE ideas_workshop_theme (id INT AUTO_INCREMENT NOT NULL, enabled TINYINT(1) NOT NULL, name VARCHAR(255) NOT NULL, canonical_name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, image_name VARCHAR(255) DEFAULT NULL, UNIQUE INDEX theme_name_unique (name), UNIQUE INDEX theme_slug_unique (slug), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
