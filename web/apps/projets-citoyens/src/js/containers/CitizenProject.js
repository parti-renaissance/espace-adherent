        ...
        return (
            <div className="citizen__wrapper">
                ...
                <p className="citizen__blurb">
                    Parce que transformer la France demande l'engagement de
                    tous, des citoyens partout dans le pays se regroupent pour
                    agir dans leurs territoires. Ils l'ont fait : pourquoi pas
                    vous ?
                </p>
                <div className="citizen__helplist">
                    <h3 className="citizen__helplist-header">
                        Un projet citoyen c'est&nbsp;quoi&nbsp;?
                    </h3>
                    <div>
                        <span className="number">1</span>
                        <p>
                            Un projet local porté par des citoyens, en lien avec
                    ...
                    <div>
                        ...
                        <p>
                            Un projet destiné à changer concrètement la vie des
                            habitants
                        </p>
                    </div>
                    <div>
