                ...
                <div className="proposal-criteria__container">
                    <div className="proposal-criteria__container__item">
                        ...
                        <p className="proposal-criteria__container__item__text">
							...
							il ne s’agit pas uniquement d’une critique ou d’un constat quant à
                    ...
                    <div className="proposal-criteria__container__item">
                        ...
                        <p className="proposal-criteria__container__item__text">
							...
							nos CGU et respecter la législation en vigueur notamment relative
							à la diffamation, la prohibition des propos, injurieux,
