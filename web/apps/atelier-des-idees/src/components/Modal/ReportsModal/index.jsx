...
function ReportsModal(props) {
    return (
        <div className="reports-modal">
            ...
            <p className="reports-modal__subtitle">Nous n’avons pas attendu l’Atelier des idées pour vous consulter. Vous êtes déjà plus de 100 000 à avoir répondu à nos consultations.</p>
