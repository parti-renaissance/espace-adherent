        ...
        return (
            <div className="success-form">
                ...
                <p className="success-form__subtitle">
                    Votre proposition va maintenant être enrichie par des adhérents pendant 10 semaines. Vous pouvez leur montrer que vous prenez en compte leurs commentaires en cliquant sur{' '}
                    <span className="success-form__subtitle__approved">Approuver</span>. Vous devrez ensuite intégrer vous-même leurs contributions à votre partie.
                </p>
