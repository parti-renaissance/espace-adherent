...
CREATE TABLE `adherent_messages` (
  ...
  `send_to_timeline` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`id`),
...
CREATE TABLE `adherent_segment` (
  ...
  `mailchimp_id` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `synchronized` tinyint(1) NOT NULL DEFAULT '0',
  `uuid` char(36) COLLATE utf8_unicode_ci NOT NULL COMMENT '(DC2Type:uuid)',
...
CREATE TABLE `adherents` (
  ...
  `programmatic_foundation_privilege` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
CREATE TABLE `donations` (
  ...
  `nationality` varchar(2) COLLATE utf8_unicode_ci DEFAULT NULL,
  `address_region` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `donator_id` int(10) unsigned DEFAULT NULL,
  `type` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `donators` (
  ...
  KEY `IDX_A902FDD7ABF665A8` (`reference_donation_id`),
  CONSTRAINT `FK_A902FDD725F06C53` FOREIGN KEY (`adherent_id`) REFERENCES `adherents` (`id`) ON DELETE SET NULL,
  CONSTRAINT `FK_A902FDD7ABF665A8` FOREIGN KEY (`reference_donation_id`) REFERENCES `donations` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `event_group_category` VALUES (1,'événement','evenement','ENABLED');
...
CREATE TABLE `referent_person_link` (
  ...
  `adherent_id` int(10) unsigned DEFAULT NULL,
  `is_co_referent` tinyint(1) NOT NULL DEFAULT '0',
...
INSERT INTO `referent_tags` VALUES (1,'Français de l\'Étranger','FOF',NULL,NULL);
...
CREATE TABLE `senator_area` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_D229BBF7AEC89CE1` (`department_tag_id`),
...
CREATE TABLE `timeline_manifesto_translations` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_F7BD6C172C2AC5D34180C698` (`translatable_id`,`locale`),
...
-- Dump completed on 2020-01-13 19:41:01
